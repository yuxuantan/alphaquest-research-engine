...
- Variant: `id_nr4_prior_session_breakout`
- Timeframe: `5m`
...
| Limited Monkey Test | failed | summary.core_beats_monkey_net_profit_rate actual=0.866 expected={'min': 0.9}<br>summary.core_beats_monkey_max_drawdown_rate actual=0.72 expected={'min': 0.9} |
