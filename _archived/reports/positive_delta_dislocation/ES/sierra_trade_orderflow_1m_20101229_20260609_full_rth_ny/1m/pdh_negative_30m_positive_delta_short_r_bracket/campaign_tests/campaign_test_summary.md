...
- Variant: `pdh_negative_30m_positive_delta_short_r_bracket`
- Timeframe: `1m`
- Overall passed: `False`

| Stage | Status | Failed Criteria |
|---|---:|---|
| Limited Core Grid Test | failed | summary.percentage_profitable_iterations actual=0.09375 expected={'min': 0.7} |
