...
- Variant: `thirty_min_classic_trend_pullback_1559`
- Timeframe: `30m`
- Overall passed: `False`

| Stage | Status | Failed Criteria |
|---|---:|---|
| Limited Core Grid Test | failed | summary.percentage_profitable_iterations actual=0.5648148148148148 expected={'min': 0.7} |
