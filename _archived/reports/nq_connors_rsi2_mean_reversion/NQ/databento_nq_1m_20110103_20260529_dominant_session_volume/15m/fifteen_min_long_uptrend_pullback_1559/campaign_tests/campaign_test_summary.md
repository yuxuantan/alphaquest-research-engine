...
- Campaign: `nq_connors_rsi2_mean_reversion`
- Variant: `fifteen_min_long_uptrend_pullback_1559`
- Timeframe: `15m`
...
| Limited Monkey Test | failed | summary.core_beats_monkey_net_profit_rate actual=0.684 expected={'min': 0.9}<br>summary.core_beats_monkey_max_drawdown_rate actual=0.58 expected={'min': 0.9} |
