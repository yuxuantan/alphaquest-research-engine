...
- Variant: `on_extreme_reclaim_vwap_filter`
- Timeframe: `5m`
- Overall passed: `False`

| Stage | Status | Failed Criteria |
|---|---:|---|
| Limited Core Grid Test | failed | summary.percentage_profitable_iterations actual=0.3055555555555556 expected={'min': 0.7} |
