...
- Campaign: `nq_overnight_intraday_reversal`
- Variant: `first15_reversal_1559`
- Timeframe: `5m`
...
| Limited Monkey Test | failed | summary.core_beats_monkey_net_profit_rate actual=0.894 expected={'min': 0.9}<br>summary.core_beats_monkey_max_drawdown_rate actual=0.69 expected={'min': 0.9} |
