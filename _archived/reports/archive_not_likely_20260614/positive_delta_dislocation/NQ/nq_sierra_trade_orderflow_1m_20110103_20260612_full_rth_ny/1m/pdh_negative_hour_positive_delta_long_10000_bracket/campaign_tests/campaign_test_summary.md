...
- Campaign: `positive_delta_dislocation`
- Variant: `pdh_negative_hour_positive_delta_long_10000_bracket`
- Timeframe: `1m`
- Overall passed: `False`

| Stage | Status | Failed Criteria |
|---|---:|---|
| Limited Core Grid Test | failed | summary.percentage_profitable_iterations actual=0.408 expected={'min': 0.7} |
