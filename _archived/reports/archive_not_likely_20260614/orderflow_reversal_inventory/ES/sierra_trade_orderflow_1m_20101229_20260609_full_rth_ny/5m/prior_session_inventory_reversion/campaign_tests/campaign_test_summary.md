...
- Campaign: `orderflow_reversal_inventory`
- Variant: `prior_session_inventory_reversion`
- Timeframe: `5m`
- Overall passed: `False`

| Stage | Status | Failed Criteria |
|---|---:|---|
| Limited Core Grid Test | failed | summary.percentage_profitable_iterations actual=0.2152777777777778 expected={'min': 0.7} |
