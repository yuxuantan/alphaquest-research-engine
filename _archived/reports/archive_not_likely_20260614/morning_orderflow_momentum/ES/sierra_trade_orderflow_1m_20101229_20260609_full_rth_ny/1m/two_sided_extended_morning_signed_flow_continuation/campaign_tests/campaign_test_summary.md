...
- Variant: `two_sided_extended_morning_signed_flow_continuation`
- Timeframe: `1m`
...
| Limited Monkey Test | failed | summary.core_beats_monkey_max_drawdown_rate actual=0.786 expected={'min': 0.8} |
