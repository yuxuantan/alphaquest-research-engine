...
- Variant: `two_sided_first_half_hour_large20_fixed_stop_continuation`
- Timeframe: `1m`
- Overall passed: `False`

| Stage | Status | Failed Criteria |
|---|---:|---|
| Limited Core Grid Test | failed | summary.percentage_profitable_iterations actual=0.6 expected={'min': 0.7} |
