...
- Variant: `two_sided_first_half_hour_signed_flow_continuation`
- Timeframe: `1m`
- Overall passed: `False`

| Stage | Status | Failed Criteria |
|---|---:|---|
| Limited Core Grid Test | failed | summary.percentage_profitable_iterations actual=0.42777777777777776 expected={'min': 0.7} |
