...
- Variant: `two_sided_large20_flow_continuation`
- Timeframe: `1m`
...
| Walk Forward Analysis (WFA) | failed | stitched_oos_metrics.profit_factor actual=1.2400619870286402 expected={'min': 1.4}<br>stitched_oos_metrics.expectancy_r actual=0.16755129926571108 expected={'min': 0.2} |
