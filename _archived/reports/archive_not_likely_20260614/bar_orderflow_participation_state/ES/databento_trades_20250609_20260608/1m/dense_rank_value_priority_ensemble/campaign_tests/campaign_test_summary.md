...
- Variant: `dense_rank_value_priority_ensemble`
- Timeframe: `1m`
...
| Walk Forward Analysis (WFA) | failed | summary.windows actual=8 expected={'min': 10}<br>stitched_oos_metrics.total_trades actual=235 expected={'min': 500} |
