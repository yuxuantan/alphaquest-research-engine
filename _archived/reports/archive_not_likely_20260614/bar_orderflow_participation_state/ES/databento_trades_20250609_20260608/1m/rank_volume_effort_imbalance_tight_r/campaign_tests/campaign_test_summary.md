...
- Variant: `rank_volume_effort_imbalance_tight_r`
- Timeframe: `1m`
...
| Walk Forward Analysis (WFA) | failed | summary.windows actual=8 expected={'min': 10}<br>stitched_oos_metrics.total_trades actual=95 expected={'min': 500} |
