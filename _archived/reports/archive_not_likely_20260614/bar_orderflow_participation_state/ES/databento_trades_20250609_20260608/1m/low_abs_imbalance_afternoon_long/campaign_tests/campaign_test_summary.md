...
- Variant: `low_abs_imbalance_afternoon_long`
- Timeframe: `1m`
...
| Walk Forward Analysis (WFA) | failed | summary.windows actual=8 expected={'min': 10}<br>stitched_oos_metrics.total_trades actual=26 expected={'min': 500} |
