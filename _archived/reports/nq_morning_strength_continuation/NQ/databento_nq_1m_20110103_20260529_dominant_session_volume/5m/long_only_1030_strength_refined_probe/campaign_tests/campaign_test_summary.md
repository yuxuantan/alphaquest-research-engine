...
- Variant: `long_only_1030_strength_refined_probe`
- Timeframe: `5m`
...
| Limited Monkey Test | failed | summary.core_beats_monkey_net_profit_rate actual=0.868 expected={'min': 0.9}<br>summary.core_beats_monkey_max_drawdown_rate actual=0.774 expected={'min': 0.9} |
