...
Mechanic: at the 09:35 ET completed 5-minute bar close, go long ES when the prior RTH close was in the lower part of the prior RTH range.

This expresses the campaign edge as the direct low-IBS long side of prior-session mean reversion.
