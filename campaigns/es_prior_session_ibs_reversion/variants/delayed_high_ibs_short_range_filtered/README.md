...
Mechanic: at the 10:00 ET completed 5-minute bar close, short ES after high prior-session IBS when the prior RTH range is within the predeclared range filter.

This expresses the campaign edge as a delayed high-IBS short entry that avoids the opening print and excludes unusually wide prior sessions.
