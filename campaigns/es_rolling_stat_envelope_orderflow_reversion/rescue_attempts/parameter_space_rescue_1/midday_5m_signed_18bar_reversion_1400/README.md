# midday_5m_signed_18bar_reversion_1400 Rescue 1

Campaign: `es_rolling_stat_envelope_orderflow_reversion`

This is the one allowed parameter-space/fixed-parameter rescue for `midday_5m_signed_18bar_reversion_1400`.
