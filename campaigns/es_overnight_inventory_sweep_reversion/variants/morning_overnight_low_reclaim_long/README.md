# morning_overnight_low_reclaim_long

Campaign: `es_overnight_inventory_sweep_reversion`

## Mechanic
From 09:30 through 11:30 ET, watch for a completed 5-minute bar that sweeps below the completed overnight low by the configured extension and then closes back above the overnight low. Enter long at the next bar open; flatten at 15:55 ET unless stop or target is hit. The overnight high and low are completed before the RTH signal window begins.
