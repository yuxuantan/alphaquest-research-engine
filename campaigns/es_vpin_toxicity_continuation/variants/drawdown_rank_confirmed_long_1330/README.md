# drawdown_rank_confirmed_long_1330

Campaign: `es_vpin_toxicity_continuation`

## Mechanic
Enter long after the completed 13:25-13:30 ET 5-minute bar when shifted prior-session VPIN proxy rank is elevated, current-session return is positive, and intraday drawdown rank is not in the quiet lower tail.
