# baseline_high_toxicity_positive_ret_long_1330

Campaign: `es_vpin_toxicity_continuation`

## Mechanic
Enter long after the completed 13:25-13:30 ET 5-minute bar when the shifted prior-session VPIN proxy rank is elevated and current-session return is positive; flatten at 15:55 ET unless stop or target is hit.
