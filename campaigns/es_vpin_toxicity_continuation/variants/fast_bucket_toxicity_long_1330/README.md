# fast_bucket_toxicity_long_1330

Campaign: `es_vpin_toxicity_continuation`

## Mechanic
Enter long after the completed 13:25-13:30 ET 5-minute bar when a faster VPIN proxy bucket construction has elevated shifted prior-session rank and current-session return is positive.
