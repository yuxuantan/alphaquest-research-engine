# extreme_toxicity_positive_ret_long_1330

Campaign: `es_vpin_toxicity_continuation`

## Mechanic
Enter long after the completed 13:25-13:30 ET 5-minute bar only when the shifted prior-session VPIN proxy rank is in an extreme upper tail and current-session return is positive.
