...
User-authorized additional rescue created on 2026-06-19. Source run: `es_vpin_toxicity_continuation/slow_bucket_toxicity_long_1330/rescue1`. Only stop distance was widened by 1.5x; entry, target/exit, data, costs, fills, sessions, and validation gates are unchanged.
