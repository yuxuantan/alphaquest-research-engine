...
User-authorized additional rescue created on 2026-06-19. Source run: `es_intraday_capitulation_orderflow_reversion/late_day_10m_capitulation_long_1530/rescue1`. Only stop distance was widened by 1.5x; entry, target/exit, data, costs, fills, sessions, and validation gates are unchanged.
