...
User-authorized additional rescue created on 2026-06-19. Source run: `es_opening_range_failed_breakout_trend_orderflow/or15_full_session_large10_trend_reclaim_1530/rescue1`. Only target_r_multiple values below 1.0R were raised to 1.0R; entry, stop, data, costs, fills, sessions, and validation gates are unchanged.
