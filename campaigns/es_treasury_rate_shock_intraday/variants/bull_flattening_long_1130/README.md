...
Mechanic: At 11:30 ET, go long ES when the latest strictly prior DGS10 change rank and 10y-2y curve-change rank are both low; flatten by 15:55.
...
Entry module: `treasury_rate_state` with setup mode `bull_flattening_long`.
