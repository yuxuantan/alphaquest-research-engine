# high_fiscal_impulse_short_1330 Strategy Modules

Entry module: `nq_fiscal_deficit_treasury_supply_state`

Mechanic: At 13:30 ET, short NQ when the 60-day-lagged three-month outlay-minus-receipt growth impulse rank is in the upper tail.

Rationale: A high outlay-minus-receipt impulse may capture fiscal deterioration and Treasury financing pressure more directly than either leg alone.
