# late_morning30_mes_signed_1130

Campaign: `nq_mes_aligned_flow_continuation`.

Mechanic: at the completed 11:30 ET signal, trade NQ in the direction of the completed 30-minute NQ move only when completed 30-minute MNQ signed-flow imbalance confirms that direction.
