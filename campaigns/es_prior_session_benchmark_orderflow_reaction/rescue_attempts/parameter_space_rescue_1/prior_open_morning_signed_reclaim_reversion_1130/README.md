# prior_open_morning_signed_reclaim_reversion_1130

Morning two-sided failed probe of the completed previous RTH open with total signed-volume counterflow confirmation.
