...
Mechanic: Contango/risk-on state plus morning-to-midday ES VWAP reclaim with signed aggregate buy-flow confirmation.
...
Profitability rationale: Low VIX/VIX3M rank states proxy easier equity-risk conditions. A same-session ES trend that pulls back to VWAP and reclaims it with net buying flow should represent institutions using VWAP-area liquidity to continue risk-on exposure rather than a blind timed long.
