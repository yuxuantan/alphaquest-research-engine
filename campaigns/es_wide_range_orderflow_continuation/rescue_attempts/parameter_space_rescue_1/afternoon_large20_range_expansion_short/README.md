# afternoon_large20_range_expansion_short rescue1
...
Changed grid: `min_range_ticks: [10, 12]`, `min_orderflow_imbalance: [0.0, 0.02, 0.04]`, `stop_pct: [0.004, 0.005, 0.006]`, `target_r_multiple: [0.5, 0.75, 1.0]`.
