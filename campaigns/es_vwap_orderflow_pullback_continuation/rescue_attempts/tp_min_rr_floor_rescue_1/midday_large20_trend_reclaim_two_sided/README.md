...
User-authorized additional rescue created on 2026-06-19. Source run: `es_vwap_orderflow_pullback_continuation/midday_large20_trend_reclaim_two_sided/run1`. Only target_r_multiple values below 1.0R were raised to 1.0R; entry, stop, data, costs, fills, sessions, and validation gates are unchanged.
