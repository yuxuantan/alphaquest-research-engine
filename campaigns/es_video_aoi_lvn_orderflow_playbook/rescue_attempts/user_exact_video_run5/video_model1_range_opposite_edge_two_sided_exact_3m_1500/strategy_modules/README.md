# video_model1_range_opposite_edge_two_sided_exact_3m_1500

Mechanics: Same entry as the range midpoint variant, but the structural target is the opposite developing value-area edge instead of the midpoint.
