# video_model1_range_midpoint_two_sided_exact_3m_1500

Mechanics: Short VAH buyer traps and long VAL seller traps after the completed 3-minute bar reaches the developing value edge, shows absorption/trapped flow, and has at least two AOI criteria.
