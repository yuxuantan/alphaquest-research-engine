# video_model2_trend_lvn_short_high_confluence_minrr_3m_1500

Run6 quality-filter variant after run5 exact-video proxy failed limited core.

Mechanic: Short-only Model 2 trend LVN pullback with higher AOI confluence, optional directional delta threshold, minimum structural target distance, and fixed-R fallback.
