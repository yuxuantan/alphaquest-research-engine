# video_model1_range_midpoint_quality_minrr_3m_1500

Run6 quality-filter variant after run5 exact-video proxy failed limited core.

Mechanic: Two-sided Model 1 value-edge false-break range trade using midpoint only when it has enough target distance; otherwise explicit fixed-R fallback.
