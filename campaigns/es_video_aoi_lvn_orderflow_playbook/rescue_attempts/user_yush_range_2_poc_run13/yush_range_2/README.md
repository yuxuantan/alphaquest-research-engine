...
- Allows entry only from 09:30:00 through 11:30:00 America/New_York.
- Allows additional entries later the same day only after the prior position is flat.
...
- Requires price within 0.5 ATR of VAL for long or VAH for short.
