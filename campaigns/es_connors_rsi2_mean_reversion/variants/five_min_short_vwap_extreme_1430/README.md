# five_min_short_vwap_extreme_1430

Mechanic: on completed 5-minute RTH bars, short ES when RSI2 is overbought, price is below the moving-average trend filter, and price is stretched above running VWAP by the configured tick extension.
