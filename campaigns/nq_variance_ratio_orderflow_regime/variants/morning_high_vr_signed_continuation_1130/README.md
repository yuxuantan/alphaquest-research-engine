...
Edge expression: From 09:50 through 11:30 ET, trade with a completed 15-minute NQ move only when the preceding 90-minute rolling variance ratio is above one and same-window aggregate signed flow agrees with the move.
