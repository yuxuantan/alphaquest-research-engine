...
Edge expression: From 11:00 through 14:30 ET, fade completed 15-minute NQ moves in low variance-ratio states when large-10 signed flow presses into a move that does not close near the bar extreme.
