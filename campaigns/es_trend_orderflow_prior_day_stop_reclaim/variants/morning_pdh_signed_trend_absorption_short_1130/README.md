# morning_pdh_signed_trend_absorption_short_1130

Campaign: `es_trend_orderflow_prior_day_stop_reclaim`

## Edge Expression
From 10:00 through 11:30 ET, trade only a prior-day-high sweep that rejects back below PDH while signed aggregate flow on the completed reclaim bar is buy-pressure absorbed into an already established downtrend.
