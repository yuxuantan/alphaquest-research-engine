# first_half_signed_trend_hold_two_sided rescue1

Campaign: `es_trend_filtered_prior_session_breakout_orderflow`

This is the single allowed parameter-space/fixed-parameter rescue for `first_half_signed_trend_hold_two_sided`.
