...
## Edge Expression
From 10:00 through 14:30 ET, trade a completed hold outside the prior RTH high/low only when total signed flow and current completed-bar trend remain aligned with the continuation direction.
