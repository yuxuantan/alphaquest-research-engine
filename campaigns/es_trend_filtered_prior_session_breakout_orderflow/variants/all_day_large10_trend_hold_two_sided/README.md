# all_day_large10_trend_hold_two_sided

Campaign: `es_trend_filtered_prior_session_breakout_orderflow`

## Edge Expression
From 10:00 through 14:30 ET, trade completed prior-level holds only when large10 orderflow and completed-bar trend alignment both confirm continuation.
