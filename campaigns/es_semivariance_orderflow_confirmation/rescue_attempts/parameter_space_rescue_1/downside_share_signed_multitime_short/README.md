...
Original results had only weak positive evidence near wider stops and shorter fixed-R exits, so the rescue tests a lower target band without changing the downside-share state or confirmation rules.
