...
User-authorized additional rescue created on 2026-06-19. Source run: `es_semivariance_orderflow_confirmation/badvol_signed_multitime_short/rescue1`. Only stop distance was widened by 1.5x; entry, target/exit, data, costs, fills, sessions, and validation gates are unchanged.
