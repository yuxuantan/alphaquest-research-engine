# first60_large20_flow_two_sided_1530

Campaign: `es_gao_last_half_hour_orderflow_confirmation`

Mechanic: First 60-minute price return and large-20 signed-flow imbalance point the same way; enter for last-half-hour continuation.
