...
User-authorized additional rescue created on 2026-06-19. Source run: `es_cftc_tff_hedging_pressure/broad_negative_pressure_short_1100/rescue1`. Only target_r_multiple values below 1.0R were raised to 1.0R; entry, stop, data, costs, fills, sessions, and validation gates are unchanged.
