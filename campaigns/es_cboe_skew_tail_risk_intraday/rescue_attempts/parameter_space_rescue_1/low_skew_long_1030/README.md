...
Rescue attempt 1: Original low-SKEW long failed core with zero profitable combinations; rescue preserves the same low-SKEW long mechanic and tests adjacent lower-tail thresholds with tighter stop/target ranges.
