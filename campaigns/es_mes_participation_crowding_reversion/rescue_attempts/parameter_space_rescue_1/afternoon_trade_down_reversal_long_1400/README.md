...
Rescue attempt 1: parameter-space-only rescue. Rescue tests nearby lower participation ranks and shorter payoff values for the low-density afternoon long expression; mechanic is unchanged.
