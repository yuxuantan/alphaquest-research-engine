...
Original results were least bad at stricter impulse and large10-flow thresholds with tighter stops. The rescue narrows the entry grid around that stricter same-mechanic expression while preserving the same impulse-pause-breakout logic.
