# nq_prior_session_flip_retest_orderflow / afternoon_large10_aligned_two_sided_flip
...
Source ES config: `campaigns/es_prior_session_flip_retest_orderflow/variants/afternoon_large10_aligned_two_sided_flip/config.yaml`.
