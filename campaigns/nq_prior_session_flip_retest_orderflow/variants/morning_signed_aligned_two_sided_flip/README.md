# nq_prior_session_flip_retest_orderflow / morning_signed_aligned_two_sided_flip
...
Source ES config: `campaigns/es_prior_session_flip_retest_orderflow/variants/morning_signed_aligned_two_sided_flip/config.yaml`.
