...
Edge expression: At the completed 13:30 ET bar, short ES when the prior-day lagged five-day ON RRP increase z-score is nonnegative to moderately high, testing whether funding-liquidity drag appears after the lunch liquidity lull.
