...
## Mechanic
Build the completed first 15-minute RTH opening range, then trade the first two-sided breakout before 10:30:00 ET only if the completed 5-minute breakout bar closes beyond the range, the 15/30-minute completed-bar trend structure agrees with breakout direction, and large-10 signed-flow imbalance confirms the same direction.
