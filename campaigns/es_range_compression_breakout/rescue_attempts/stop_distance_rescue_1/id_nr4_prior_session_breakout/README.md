...
User-authorized additional rescue created on 2026-06-19. Source run: `es_range_compression_breakout/id_nr4_prior_session_breakout/run1`. Only stop distance was widened by 1.5x; entry, target/exit, data, costs, fills, sessions, and validation gates are unchanged.
