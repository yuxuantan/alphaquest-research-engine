# nr7_opening_range_15_long_breakout

Mechanic: after a completed prior RTH session ranks as the narrowest range in the last seven sessions, trade only long breakouts above the completed first 15-minute opening range.
