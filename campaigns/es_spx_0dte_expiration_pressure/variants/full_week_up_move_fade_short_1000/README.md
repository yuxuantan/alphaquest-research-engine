# full_week_up_move_fade_short_1000

Campaign: `es_spx_0dte_expiration_pressure`

Mechanic: After the completed 09:59-10:00 ET bar during the post-May-2022 full-week SPX 0DTE regime, short ES only if ES is up from the session open by at least the threshold. This tests whether early upside extension is faded by same-day expiry hedging/pinning flows.
