...
User-authorized additional rescue created on 2026-06-19. Source run: `es_cboe_vix_level_state_intraday/low_vix_complacency_short_1030/rescue1`. Only target_r_multiple values below 1.0R were raised to 1.0R; entry, stop, data, costs, fills, sessions, and validation gates are unchanged.
