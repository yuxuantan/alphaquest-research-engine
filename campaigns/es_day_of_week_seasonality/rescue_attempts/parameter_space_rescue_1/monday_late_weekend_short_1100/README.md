# monday_late_weekend_short_1100 Rescue 1

Campaign: `es_day_of_week_seasonality`

This is the single allowed rescue for `monday_late_weekend_short_1100`. It changes only the declared stop and target parameter space:
