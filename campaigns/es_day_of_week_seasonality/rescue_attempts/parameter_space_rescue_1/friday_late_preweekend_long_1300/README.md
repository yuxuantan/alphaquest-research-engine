# friday_late_preweekend_long_1300 Rescue 1

Campaign: `es_day_of_week_seasonality`

This is the single allowed rescue for `friday_late_preweekend_long_1300`. It changes only the declared stop and target parameter space:
