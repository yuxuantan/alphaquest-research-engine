# mon_fri_polarity_pair_1000 Rescue 1

Campaign: `es_day_of_week_seasonality`

This is the single allowed rescue for `mon_fri_polarity_pair_1000`. It changes only the declared stop and target parameter space:
