# two_sided_overnight_sign_continuation_1530 Rescue 1
...
## Rationale
Original two-sided continuation failed core with no profitable combos; rescue tests only larger overnight moves and shorter late-day targets while preserving continuation direction.
