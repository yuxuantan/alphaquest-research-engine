# negative_overnight_short_1530

Campaign: `es_overnight_return_late_day_momentum`

## Mechanic
At the completed 15:25-15:30 ET bar, enter short only when the RTH open is below the prior RTH close by at least the threshold; flatten at 15:55 ET unless stop or target is hit.
