# late_morning_15m_absorption_fade_1130 rescue1

Campaign: `es_orderflow_absorption_exhaustion_reversal`

This is the single allowed rescue for `late_morning_15m_absorption_fade_1130`. It keeps the same `orderflow_regime` absorption/exhaustion reversal entry module, `percent_from_entry` stop module, `fixed_r` target module, 1-minute timeframe, Sierra RTH data window, costs, fills, and validation gates.
