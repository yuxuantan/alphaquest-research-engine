# early_5m_absorption_fade_1000 rescue1

Campaign: `es_orderflow_absorption_exhaustion_reversal`

This is the single allowed rescue for `early_5m_absorption_fade_1000`. It keeps the same `orderflow_regime` absorption/exhaustion reversal entry module, `percent_from_entry` stop module, `fixed_r` target module, 1-minute timeframe, Sierra RTH data window, costs, fills, and validation gates.
