...
Mechanic: after a 1-3 point ES RTH opening gap from the prior RTH close, wait for the completed 09:45-10:00 ET window. Fade the gap only when large-20 aggregate signed-flow imbalance is against the gap.

Why this expresses the edge: the opening gap supplies the price-action dislocation and the later large-trade flow condition attempts to identify absorption rather than immediate continuation.
