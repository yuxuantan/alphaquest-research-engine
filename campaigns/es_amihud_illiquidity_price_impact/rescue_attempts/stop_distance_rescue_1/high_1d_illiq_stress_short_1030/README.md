...
User-authorized additional rescue created on 2026-06-19. Source run: `es_amihud_illiquidity_price_impact/high_1d_illiq_stress_short_1030/run1`. Only stop distance was widened by 1.5x; entry, target/exit, data, costs, fills, sessions, and validation gates are unchanged.
