...
User-authorized additional rescue created on 2026-06-19. Source run: `es_round_number_barrier_reaction/round_number_downside_breakout_short/run1`. Only stop distance was widened by 1.5x; entry, target/exit, data, costs, fills, sessions, and validation gates are unchanged.
