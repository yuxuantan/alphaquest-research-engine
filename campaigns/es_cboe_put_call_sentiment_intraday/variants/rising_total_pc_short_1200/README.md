...
Mechanic: at 12:00 ET, short ES when the latest prior total Cboe put/call ratio one-day change ranks in the upper tail of its 252-session history. The signal uses the completed 11:59-12:00 ET bar and enters next bar open.
