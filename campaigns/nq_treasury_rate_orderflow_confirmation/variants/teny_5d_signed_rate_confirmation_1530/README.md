...
A multi-day 10-year yield move may represent persistent discount-rate pressure or relief; NQ continuation requires same-day price and flow confirmation. This variant uses 5-day 10-year yield change rank and signed_volume confirmation. The signal waits for a completed 5-minute NQ bar, enters on the next bar, and never uses same-session Treasury observations.
