...
User-authorized additional rescue created on 2026-06-19. Source run: `es_opening_range_nq_orderflow_breakout/or30_nq15_signed_breakout_1030/rescue1`. Only stop distance was widened by 1.5x; entry, target/exit, data, costs, fills, sessions, and validation gates are unchanged.
