# afternoon60_signed_two_sided_1400

Campaign: `es_mes_lead_lag_catchup`.

Mechanic: from 13:00 through 15:00 ET, follow the completed rolling 60-minute MES direction in ES only when ES lags MES by the configured tick gap and MES signed-flow imbalance confirms the MES direction.
