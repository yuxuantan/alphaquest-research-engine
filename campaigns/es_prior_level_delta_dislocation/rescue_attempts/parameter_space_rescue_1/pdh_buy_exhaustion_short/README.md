# pdh_buy_exhaustion_short rescue1

Campaign: `es_prior_level_delta_dislocation`

This is the single allowed rescue for `pdh_buy_exhaustion_short`. It keeps the same `positive_delta_dislocation` entry module, `percent_from_entry` stop module, `fixed_r` target module, 1-minute timeframe, Sierra RTH data window, costs, fill assumptions, and validation gates.
