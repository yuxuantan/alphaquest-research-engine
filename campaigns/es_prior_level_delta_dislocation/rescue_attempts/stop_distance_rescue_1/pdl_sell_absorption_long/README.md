...
User-authorized additional rescue created on 2026-06-19. Source run: `es_prior_level_delta_dislocation/pdl_sell_absorption_long/rescue1`. Only stop distance was widened by 1.5x; entry, target/exit, data, costs, fills, sessions, and validation gates are unchanged.
