# brent_wti_spread_widen_short_1330

Mechanic: at 13:30 ET, short ES when the two-business-day-lagged Brent-minus-WTI spread change ranks in the upper tail of its 252-session history. The signal uses the completed 13:30 ET bar and enters next bar open.
