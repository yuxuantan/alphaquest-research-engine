# wti_up_risk_off_short_1030

Mechanic: at 10:30 ET, short ES when the two-business-day-lagged WTI one-day return ranks in the upper tail of its 252-session history. The signal uses the completed 10:30 ET bar and enters next bar open.
