# friday_open_preweekend_long_0935

Campaign: `nq_day_of_week_seasonality`

## Mechanic
After the first completed 5-minute RTH bar on Fridays, go long NQ to test positive pre-weekend weekday drift. The signal uses only the known weekday and the completed 5-minute bar ending at `09:35:00`; the engine enters at the next bar open and flattens by `15:55:00` ET unless the stop or target is hit first.
