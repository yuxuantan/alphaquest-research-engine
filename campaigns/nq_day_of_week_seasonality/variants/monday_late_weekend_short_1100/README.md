...
## Mechanic
After the completed 10:55-11:00 ET bar on Mondays, short NQ to test whether the Monday effect persists after opening auction noise. The signal uses only the known weekday and the completed 5-minute bar ending at `11:00:00`; the engine enters at the next bar open and flattens by `15:55:00` ET unless the stop or target is hit first.
