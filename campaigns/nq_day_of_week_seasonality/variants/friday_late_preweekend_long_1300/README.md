...
## Mechanic
After the completed 12:55-13:00 ET bar on Fridays, go long NQ to test whether pre-weekend strength is concentrated after midday. The signal uses only the known weekday and the completed 5-minute bar ending at `13:00:00`; the engine enters at the next bar open and flattens by `15:55:00` ET unless the stop or target is hit first.
