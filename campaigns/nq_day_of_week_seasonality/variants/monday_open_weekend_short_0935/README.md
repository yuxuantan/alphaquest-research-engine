...
## Mechanic
After the first completed 5-minute RTH bar on Mondays, short NQ to test whether weekend/Monday weakness appears quickly after the open. The signal uses only the known weekday and the completed 5-minute bar ending at `09:35:00`; the engine enters at the next bar open and flattens by `15:55:00` ET unless the stop or target is hit first.
