# exclude_extreme_absret5_trade_morning_1030

At 10:30 ET, take a two-sided ES trend-pullback fade only when MES trade participation is elevated over the completed 15-minute pullback, the prior completed 30-minute ES trend points opposite the pullback, and the lagged volatility filter passes: exclude top 5% prior 5-day average absolute-return rank. Entry is next bar open.
