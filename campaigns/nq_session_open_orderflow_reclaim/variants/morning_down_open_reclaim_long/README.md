...
Mechanic: After NQ has traded at least the configured distance below the current RTH open on a prior completed bar, buy a completed reclaim of the RTH open when same-bar aggregate signed flow is positive enough.
