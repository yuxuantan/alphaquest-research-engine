# late_morning_large10_two_sided_acceptance

Late-morning prior value-area large-10 two-sided acceptance.

Mechanic: From 10:00 through 12:30 ET, enter long above prior VAH or short below prior VAL after a completed 5-minute close beyond the configured buffer, requiring same-direction large-10 signed-flow imbalance on the completed signal bar.
