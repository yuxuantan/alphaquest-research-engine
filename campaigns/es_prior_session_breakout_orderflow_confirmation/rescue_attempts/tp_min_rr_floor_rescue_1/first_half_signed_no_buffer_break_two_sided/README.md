# first_half_signed_no_buffer_break_two_sided

Campaign: `es_prior_session_breakout_orderflow_confirmation`

## Mechanic
From 09:35 through 13:30 ET, trade the first fresh prior-high/low close break when total signed flow confirms the break; no close buffer is added.
...
User-authorized additional rescue created on 2026-06-19. Source run: `es_prior_session_breakout_orderflow_confirmation/first_half_signed_no_buffer_break_two_sided/run1`. Only target_r_multiple values below 1.0R were raised to 1.0R; entry, stop, data, costs, fills, sessions, and validation gates are unchanged.
