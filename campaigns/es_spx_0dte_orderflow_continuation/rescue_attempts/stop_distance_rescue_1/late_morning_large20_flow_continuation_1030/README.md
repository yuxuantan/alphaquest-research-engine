...
User-authorized additional rescue created on 2026-06-19. Source run: `es_spx_0dte_orderflow_continuation/late_morning_large20_flow_continuation_1030/rescue1`. Only stop distance was widened by 1.5x; entry, target/exit, data, costs, fills, sessions, and validation gates are unchanged.
