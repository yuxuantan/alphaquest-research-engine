...
Mechanic: At 12:00 ET on the last regular RTH session before a full NYSE holiday, enter long NQ only if the completed RTH return is at least the configured threshold; flatten by 15:55 ET unless stop or target is hit.

Source ES config: `campaigns/es_preholiday_effect/variants/preholiday_momentum_confirmed_midday_long_1200/config.yaml`
