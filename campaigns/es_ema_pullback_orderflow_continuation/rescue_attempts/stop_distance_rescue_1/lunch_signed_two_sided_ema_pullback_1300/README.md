...
User-authorized additional rescue created on 2026-06-19. Source run: `es_ema_pullback_orderflow_continuation/lunch_signed_two_sided_ema_pullback_1300/rescue1`. Only stop distance was widened by 1.5x; entry, target/exit, data, costs, fills, sessions, and validation gates are unchanged.
