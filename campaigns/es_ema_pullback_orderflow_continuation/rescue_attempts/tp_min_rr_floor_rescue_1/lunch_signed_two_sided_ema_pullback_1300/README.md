# lunch_signed_two_sided_ema_pullback_1300 rescue1
...
User-authorized additional rescue created on 2026-06-19. Source run: `es_ema_pullback_orderflow_continuation/lunch_signed_two_sided_ema_pullback_1300/rescue1`. Only target_r_multiple values below 1.0R were raised to 1.0R; entry, stop, data, costs, fills, sessions, and validation gates are unchanged.
