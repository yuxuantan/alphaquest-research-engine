...
Original grid had zero profitable combinations; top result sat near the wider stop boundary with 1.0R target, so the rescue tests a slightly wider ETH-window stop ladder while retaining 1.0R as the floor and adding only predeclared higher-R targets.
