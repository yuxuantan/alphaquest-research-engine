...
Staged validation failed closed. Four variants failed `limited_core_grid_test`; `btc_volatility_riskoff_short_1330` passed limited core and then failed `limited_monkey_test`.
...
Final decision: FAIL. No variant reached WFA, Monte Carlo, simulated incubation, acceptance OOS, or candidate reporting.
