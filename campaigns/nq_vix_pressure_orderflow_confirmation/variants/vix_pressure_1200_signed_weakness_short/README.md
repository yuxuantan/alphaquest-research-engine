# vix_pressure_1200_signed_weakness_short

Campaign: `nq_vix_pressure_orderflow_confirmation`.

Mechanic: At 12:00 ET, short NQ only when lagged VIX-change pressure is present and completed half-day price action plus signed aggregate orderflow remain downside-confirmed.
