# vix_pressure_1030_large20_weakness_short

Campaign: `nq_vix_pressure_orderflow_confirmation`.

Mechanic: At 10:30 ET, short NQ only when lagged VIX-change pressure is present and the completed RTH open-to-signal move plus large-20-lot aggregate orderflow confirm downside pressure.
