# vix_pressure_1200_large20_weakness_short

Campaign: `nq_vix_pressure_orderflow_confirmation`.

Mechanic: At 12:00 ET, short NQ only when lagged VIX-change pressure is present and completed half-day price action plus large-20-lot aggregate orderflow remain downside-confirmed.
