...
Original best row was closest but under the trade-density preference and still negative; rescue lowers the completed-return and flow-magnitude thresholds while preserving high-VR continuation and signed-flow alignment. Entry module, stop module, target module, data, costs, sessions, and validation gates are unchanged.
