...
The campaign passed the pre-PnL density screen, but staged validation failed closed at `limited_core_grid_test` for all five predeclared variants.
...
- `stoxx_1d_weakness_short_1400` had benchmark-passing cells, but its profitable iteration rate was below the required stability threshold.
