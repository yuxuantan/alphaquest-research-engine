...
1. **Authored research:** `research/campaigns/active/`, the closed-definition archive, policy, and reference configuration.
2. **Engine:** reusable deterministic code under `src/alphaquest/`.
3. **Generated evidence:** immutable run outputs under `research/evidence/runs/`.
