...
def test_campaign_schema_accepts_representative_authored_campaign():
    ...
    campaign = yaml.safe_load(Path("campaigns/es_amihud_illiquidity_price_impact/campaign.yaml").read_text(encoding="utf-8"))
...
def test_variant_schema_accepts_representative_authored_config():
    ...
    config_path = next(Path("campaigns/es_amihud_illiquidity_price_impact/variants").glob("*/config.yaml"))
