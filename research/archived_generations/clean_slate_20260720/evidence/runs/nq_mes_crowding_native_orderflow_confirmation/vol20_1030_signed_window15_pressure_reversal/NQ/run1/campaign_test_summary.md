...
- Variant: `vol20_1030_signed_window15_pressure_reversal`
- Timeframe: `1m`
...
| Limited Monkey Test | failed | summary.core_beats_monkey_net_profit_rate actual=0.874 expected={'min': 0.9}<br>summary.core_beats_monkey_max_drawdown_rate actual=0.739875 expected={'min': 0.9} |
