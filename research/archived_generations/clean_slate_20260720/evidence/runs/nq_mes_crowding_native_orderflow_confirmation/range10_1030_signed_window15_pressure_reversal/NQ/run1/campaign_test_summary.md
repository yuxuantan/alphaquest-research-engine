...
- Variant: `range10_1030_signed_window15_pressure_reversal`
- Timeframe: `1m`
...
| Limited Monkey Test | failed | summary.core_beats_monkey_net_profit_rate actual=0.799875 expected={'min': 0.9}<br>summary.core_beats_monkey_max_drawdown_rate actual=0.524625 expected={'min': 0.9} |
