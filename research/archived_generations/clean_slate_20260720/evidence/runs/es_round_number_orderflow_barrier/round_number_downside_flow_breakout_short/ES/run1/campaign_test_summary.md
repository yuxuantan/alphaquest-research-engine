...
- Variant: `round_number_downside_flow_breakout_short`
- Timeframe: `5m`
- Overall passed: `False`

| Stage | Status | Failed Criteria |
|---|---:|---|
| Limited Core Grid Test | failed | summary.percentage_profitable_iterations actual=0.12962962962962962 expected={'min': 0.7} |
