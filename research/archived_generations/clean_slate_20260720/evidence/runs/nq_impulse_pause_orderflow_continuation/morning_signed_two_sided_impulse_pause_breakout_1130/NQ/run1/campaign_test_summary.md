...
- Variant: `morning_signed_two_sided_impulse_pause_breakout_1130`
- Timeframe: `5m`
- Overall passed: `False`

| Stage | Status | Failed Criteria |
|---|---:|---|
| Limited Core Grid Test | failed | summary.percentage_profitable_iterations actual=0.5308641975308642 expected={'min': 0.7} |
