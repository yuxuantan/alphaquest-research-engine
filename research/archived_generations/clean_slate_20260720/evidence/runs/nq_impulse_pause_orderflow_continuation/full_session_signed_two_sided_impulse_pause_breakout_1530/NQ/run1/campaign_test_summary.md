...
- Variant: `full_session_signed_two_sided_impulse_pause_breakout_1530`
- Timeframe: `5m`
- Overall passed: `False`

| Stage | Status | Failed Criteria |
|---|---:|---|
| Limited Core Grid Test | failed | summary.percentage_profitable_iterations actual=0.5432098765432098 expected={'min': 0.7} |
