...
- Variant: `vix_pressure_1130_vwap_signed_pressure_short`
- Timeframe: `1m`
...
| Limited Monkey Test | failed | summary.core_beats_monkey_net_profit_rate actual=0.8775 expected={'min': 0.9}<br>summary.core_beats_monkey_max_drawdown_rate actual=0.583375 expected={'min': 0.9} |
