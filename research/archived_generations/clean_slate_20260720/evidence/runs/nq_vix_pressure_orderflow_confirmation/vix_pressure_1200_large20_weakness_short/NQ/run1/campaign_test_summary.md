...
- Variant: `vix_pressure_1200_large20_weakness_short`
- Timeframe: `1m`
...
| Limited Monkey Test | failed | summary.core_beats_monkey_net_profit_rate actual=0.883875 expected={'min': 0.9}<br>summary.core_beats_monkey_max_drawdown_rate actual=0.732625 expected={'min': 0.9} |
