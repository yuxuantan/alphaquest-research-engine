...
- Campaign: `nq_prior_value_area_orderflow_acceptance`
- Variant: `morning_signed_val_acceptance_short`
- Timeframe: `5m`
- Overall passed: `False`

| Stage | Status | Failed Criteria |
|---|---:|---|
| Limited Core Grid Test | failed | summary.percentage_profitable_iterations actual=0.09259259259259259 expected={'min': 0.7} |
