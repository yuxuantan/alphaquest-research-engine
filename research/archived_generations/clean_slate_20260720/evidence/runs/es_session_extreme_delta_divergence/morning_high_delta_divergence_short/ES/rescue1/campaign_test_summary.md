...
- Campaign: `es_session_extreme_delta_divergence`
- Variant: `morning_high_delta_divergence_short`
- Timeframe: `1m`
- Overall passed: `False`

| Stage | Status | Failed Criteria |
|---|---:|---|
| Limited Core Grid Test | failed | summary.percentage_profitable_iterations actual=0.027777777777777776 expected={'min': 0.7} |
