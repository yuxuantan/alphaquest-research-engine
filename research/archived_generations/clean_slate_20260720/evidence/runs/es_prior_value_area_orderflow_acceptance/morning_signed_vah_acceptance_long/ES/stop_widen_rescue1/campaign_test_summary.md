...
- Campaign: `es_prior_value_area_orderflow_acceptance`
- Variant: `morning_signed_vah_acceptance_long`
- Timeframe: `5m`
...
| Limited Monkey Test | failed | summary.core_beats_monkey_net_profit_rate actual=0.89075 expected={'min': 0.9}<br>summary.core_beats_monkey_max_drawdown_rate actual=0.8905 expected={'min': 0.9} |
