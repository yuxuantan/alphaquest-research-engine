...
- Campaign: `nq_variance_ratio_orderflow_regime`
- Variant: `morning_high_vr_signed_continuation_1130`
- Timeframe: `5m`
- Overall passed: `False`

| Stage | Status | Failed Criteria |
|---|---:|---|
| Limited Core Grid Test | failed | summary.percentage_profitable_iterations actual=0.32098765432098764 expected={'min': 0.7} |
