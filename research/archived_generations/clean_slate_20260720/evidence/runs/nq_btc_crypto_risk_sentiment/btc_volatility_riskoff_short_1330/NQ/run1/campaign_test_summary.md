...
- Campaign: `nq_btc_crypto_risk_sentiment`
- Variant: `btc_volatility_riskoff_short_1330`
- Timeframe: `1m`
...
| Limited Monkey Test | failed | summary.core_beats_monkey_net_profit_rate actual=0.73475 expected={'min': 0.9}<br>summary.core_beats_monkey_max_drawdown_rate actual=0.676875 expected={'min': 0.9} |
