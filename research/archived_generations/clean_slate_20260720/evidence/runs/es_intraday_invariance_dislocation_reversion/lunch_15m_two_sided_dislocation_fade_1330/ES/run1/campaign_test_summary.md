...
- Variant: `lunch_15m_two_sided_dislocation_fade_1330`
- Timeframe: `1m`
- Overall passed: `False`

| Stage | Status | Failed Criteria |
|---|---:|---|
| Limited Core Grid Test | failed | summary.percentage_profitable_iterations actual=0.25925925925925924 expected={'min': 0.7} |
