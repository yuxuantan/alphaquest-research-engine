...
- Campaign: `es_pivot_filtered_mes_participation_crowding_reversion`
- Variant: `morning_notional_two_sided_reversal_window_1130`
- Timeframe: `1m`
- Overall passed: `False`

| Stage | Status | Failed Criteria |
|---|---:|---|
| Limited Core Grid Test | failed | summary.percentage_profitable_iterations actual=0.08641975308641975 expected={'min': 0.7} |
