...
- Variant: `priority_short1030_long1130_base`
- Timeframe: `5m`
...
| Limited Monkey Test | failed | summary.core_beats_monkey_net_profit_rate actual=0.8166666666666667 expected={'min': 0.9}<br>summary.core_beats_monkey_max_drawdown_rate actual=0.68 expected={'min': 0.9} |
