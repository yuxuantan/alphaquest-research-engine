...
- Variant: `short_only_1030_weakness`
- Timeframe: `5m`
...
| Limited Monkey Test | failed | summary.core_beats_monkey_net_profit_rate actual=0.85 expected={'min': 0.9}<br>summary.core_beats_monkey_max_drawdown_rate actual=0.7566666666666667 expected={'min': 0.9} |
