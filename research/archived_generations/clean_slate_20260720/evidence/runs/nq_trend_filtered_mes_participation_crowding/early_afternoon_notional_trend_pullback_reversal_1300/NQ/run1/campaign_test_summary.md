...
- Variant: `early_afternoon_notional_trend_pullback_reversal_1300`
- Timeframe: `1m`
- Overall passed: `False`

| Stage | Status | Failed Criteria |
|---|---:|---|
| Limited Core Grid Test | failed | summary.percentage_profitable_iterations actual=0.6296296296296297 expected={'min': 0.7} |
