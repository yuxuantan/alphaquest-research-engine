...
- Campaign: `nq_prior_session_ibs_reversion`
...
|---|---:|---|
| Limited Core Grid Test | failed | summary.percentage_profitable_iterations actual=0.5833333333333334 expected={'min': 0.7} |
