...
- Variant: `open60_flow_continuation_1130`
- Timeframe: `1m`
...
| Limited Monkey Test | failed | summary.core_beats_monkey_net_profit_rate actual=0.645375 expected={'min': 0.9}<br>summary.core_beats_monkey_max_drawdown_rate actual=0.620875 expected={'min': 0.9} |
