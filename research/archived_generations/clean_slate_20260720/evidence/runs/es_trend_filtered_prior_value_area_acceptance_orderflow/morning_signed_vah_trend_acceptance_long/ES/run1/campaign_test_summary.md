...
- Campaign: `es_trend_filtered_prior_value_area_acceptance_orderflow`
- Variant: `morning_signed_vah_trend_acceptance_long`
- Timeframe: `5m`
- Overall passed: `False`

| Stage | Status | Failed Criteria |
|---|---:|---|
| Limited Core Grid Test | failed | summary.percentage_profitable_iterations actual=0.024691358024691357 expected={'min': 0.7} |
