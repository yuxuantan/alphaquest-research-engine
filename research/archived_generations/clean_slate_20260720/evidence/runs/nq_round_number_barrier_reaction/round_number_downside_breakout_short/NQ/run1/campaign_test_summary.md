...
- Campaign: `nq_round_number_barrier_reaction`
- Variant: `round_number_downside_breakout_short`
- Timeframe: `5m`
- Overall passed: `False`

| Stage | Status | Failed Criteria |
|---|---:|---|
| Limited Core Grid Test | failed | summary.percentage_profitable_iterations actual=0.42592592592592593 expected={'min': 0.7} |
