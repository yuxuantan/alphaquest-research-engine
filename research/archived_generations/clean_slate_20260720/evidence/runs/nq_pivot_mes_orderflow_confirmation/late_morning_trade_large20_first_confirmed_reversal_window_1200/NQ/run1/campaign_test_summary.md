...
- Variant: `late_morning_trade_large20_first_confirmed_reversal_window_1200`
- Timeframe: `1m`
...
| Limited Monkey Test | failed | summary.core_beats_monkey_net_profit_rate actual=0.799625 expected={'min': 0.9}<br>summary.core_beats_monkey_max_drawdown_rate actual=0.851125 expected={'min': 0.9} |
