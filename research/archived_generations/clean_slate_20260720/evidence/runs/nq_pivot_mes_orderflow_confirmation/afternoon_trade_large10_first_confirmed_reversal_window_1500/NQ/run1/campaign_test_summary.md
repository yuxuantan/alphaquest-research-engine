...
- Variant: `afternoon_trade_large10_first_confirmed_reversal_window_1500`
- Timeframe: `1m`
...
| Limited Monkey Test | failed | summary.core_beats_monkey_net_profit_rate actual=0.867875 expected={'min': 0.9}<br>summary.core_beats_monkey_max_drawdown_rate actual=0.77 expected={'min': 0.9} |
