...
- Variant: `morning_notional_large20_first_confirmed_reversal_window_1130`
- Timeframe: `1m`
- Overall passed: `False`

| Stage | Status | Failed Criteria |
|---|---:|---|
| Limited Core Grid Test | failed | summary.percentage_profitable_iterations actual=0.41975308641975306 expected={'min': 0.7} |
