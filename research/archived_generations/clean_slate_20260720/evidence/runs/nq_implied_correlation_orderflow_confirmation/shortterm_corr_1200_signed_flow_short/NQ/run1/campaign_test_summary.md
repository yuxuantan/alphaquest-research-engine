...
- Variant: `shortterm_corr_1200_signed_flow_short`
- Timeframe: `1m`
...
| Limited Monkey Test | failed | summary.core_beats_monkey_net_profit_rate actual=0.847375 expected={'min': 0.9}<br>summary.core_beats_monkey_max_drawdown_rate actual=0.819625 expected={'min': 0.9} |
