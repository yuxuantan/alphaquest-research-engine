...
- Variant: `nonquarterly_post_opex_monday_reversal_long_1000`
- Timeframe: `1m`
- Overall passed: `False`

| Stage | Status | Failed Criteria |
|---|---:|---|
| Limited Core Grid Test | failed | summary.percentage_profitable_iterations actual=0.5 expected={'min': 0.7} |
