...
- Campaign: `nq_credit_etf_orderflow_risk_appetite`
- Variant: `hyg_1d_weakness_signed_short_1230`
- Timeframe: `5m`
- Overall passed: `False`

| Stage | Status | Failed Criteria |
|---|---:|---|
| Limited Core Grid Test | failed | summary.percentage_profitable_iterations actual=0.2716049382716049 expected={'min': 0.7} |
