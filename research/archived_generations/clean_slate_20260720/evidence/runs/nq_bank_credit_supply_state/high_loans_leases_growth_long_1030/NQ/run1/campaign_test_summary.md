...
- Campaign: `nq_bank_credit_supply_state`
- Variant: `high_loans_leases_growth_long_1030`
- Timeframe: `1m`
...
| Limited Monkey Test | failed | summary.core_beats_monkey_net_profit_rate actual=0.800625 expected={'min': 0.9}<br>summary.core_beats_monkey_max_drawdown_rate actual=0.800125 expected={'min': 0.9} |
