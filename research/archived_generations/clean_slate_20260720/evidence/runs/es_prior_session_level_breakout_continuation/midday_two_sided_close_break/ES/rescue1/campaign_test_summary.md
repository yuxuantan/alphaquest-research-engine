...
- Variant: `midday_two_sided_close_break`
- Timeframe: `5m`
...
| Limited Monkey Test | failed | summary.core_beats_monkey_net_profit_rate actual=0.776625 expected={'min': 0.9}<br>summary.core_beats_monkey_max_drawdown_rate actual=0.6215 expected={'min': 0.9} |
