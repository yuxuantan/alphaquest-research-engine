...
- Variant: `morning_prior_high_breakout_long`
- Timeframe: `5m`
...
| Limited Monkey Test | failed | summary.core_beats_monkey_net_profit_rate actual=0.870125 expected={'min': 0.9}<br>summary.core_beats_monkey_max_drawdown_rate actual=0.7355 expected={'min': 0.9} |
