...
- Campaign: `es_pivot_filtered_prior_value_area_acceptance`
- Variant: `morning_signed_vah_pivot_acceptance_long`
- Timeframe: `5m`
- Overall passed: `False`

| Stage | Status | Failed Criteria |
|---|---:|---|
| Limited Core Grid Test | failed | summary.percentage_profitable_iterations actual=0.6111111111111112 expected={'min': 0.7} |
