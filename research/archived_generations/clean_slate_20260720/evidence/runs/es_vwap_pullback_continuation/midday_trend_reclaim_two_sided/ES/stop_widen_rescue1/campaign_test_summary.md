...
- Variant: `midday_trend_reclaim_two_sided`
- Timeframe: `5m`
...
| Limited Monkey Test | failed | summary.core_beats_monkey_net_profit_rate actual=0.872125 expected={'min': 0.9}<br>summary.core_beats_monkey_max_drawdown_rate actual=0.60475 expected={'min': 0.9} |
