...
| Simulated Incubation (OOS) Core | failed | metrics.profit_factor actual=0.8575848936845446 expected={'min': 1.0}<br>metrics.mar actual=-0.4900862969730439 expected={'min': 1.0} |
