...
- Campaign: `es_oil_price_shock_spillover`
- Variant: `wti_up_risk_off_short_1030`
- Timeframe: `1m`
...
| Limited Monkey Test | failed | summary.core_beats_monkey_net_profit_rate actual=0.836125 expected={'min': 0.9}<br>summary.core_beats_monkey_max_drawdown_rate actual=0.425125 expected={'min': 0.9} |
