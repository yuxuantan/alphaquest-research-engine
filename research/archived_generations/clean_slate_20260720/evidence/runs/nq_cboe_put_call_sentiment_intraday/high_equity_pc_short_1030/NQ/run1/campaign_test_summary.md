...
- Variant: `high_equity_pc_short_1030`
- Timeframe: `1m`
...
| Walk Forward Analysis (WFA) | failed | summary.early_exit actual=True expected={'equals': False}<br>stitched_oos_metrics.profit_factor actual=0.8344453064391001 expected={'min': 1.2}<br>stitched_oos_metrics.mar actual=-0.5295516927947286 expected={'min': 0.4} |
