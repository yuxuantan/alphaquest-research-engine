...
- Variant: `falling_total_pc_long_1130`
- Timeframe: `1m`
...
| Walk Forward Analysis (WFA) | failed | summary.early_exit actual=True expected={'equals': False}<br>stitched_oos_metrics.profit_factor actual=0.8707482993197279 expected={'min': 1.2}<br>stitched_oos_metrics.mar actual=-0.47633200537886 expected={'min': 0.4} |
