...
- Variant: `od15_trade_failed_extension_reversal_1130`
- Timeframe: `1m`
- Overall passed: `False`

| Stage | Status | Failed Criteria |
|---|---:|---|
| Limited Core Grid Test | failed | summary.percentage_profitable_iterations actual=0.06172839506172839 expected={'min': 0.7} |
