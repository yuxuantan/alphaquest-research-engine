...
- Campaign: `es_opening_drive_mes_crowding_reversal`
- Variant: `od30_notional_failed_extension_reversal_1300`
- Timeframe: `1m`
- Overall passed: `False`

| Stage | Status | Failed Criteria |
|---|---:|---|
| Limited Core Grid Test | failed | summary.percentage_profitable_iterations actual=0.35802469135802467 expected={'min': 0.7} |
