...
- Variant: `morning_low_extreme_reclaim_long_1130`
- Timeframe: `5m`
- Overall passed: `False`

| Stage | Status | Failed Criteria |
|---|---:|---|
| Limited Core Grid Test | failed | summary.percentage_profitable_iterations actual=0.16049382716049382 expected={'min': 0.7} |
