...
- Variant: `morning_mes_buy_pressure_reversion_short`
- Timeframe: `1m`
...
| Limited Monkey Test | failed | summary.core_beats_monkey_net_profit_rate actual=0.8366666666666667 expected={'min': 0.9}<br>summary.core_beats_monkey_max_drawdown_rate actual=0.8766666666666667 expected={'min': 0.9} |
