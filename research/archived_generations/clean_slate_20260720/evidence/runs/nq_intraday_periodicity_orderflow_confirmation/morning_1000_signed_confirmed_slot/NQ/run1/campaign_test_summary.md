...
- Variant: `morning_1000_signed_confirmed_slot`
- Timeframe: `1m`
- Overall passed: `False`

| Stage | Status | Failed Criteria |
|---|---:|---|
| Limited Core Grid Test | failed | summary.percentage_profitable_iterations actual=0.05555555555555555 expected={'min': 0.7} |
