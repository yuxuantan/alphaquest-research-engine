...
- Campaign: `nq_nyfed_rrp_liquidity_state`
- Variant: `rrp_drain_short_1000`
- Timeframe: `5m`
...
| Limited Monkey Test | failed | summary.core_beats_monkey_net_profit_rate actual=0.89775 expected={'min': 0.9}<br>summary.core_beats_monkey_max_drawdown_rate actual=0.7525 expected={'min': 0.9} |
