...
- Variant: `nikkei_5d_strength_long_1030`
- Timeframe: `1m`
...
| Limited Monkey Test | failed | summary.core_beats_monkey_net_profit_rate actual=0.81975 expected={'min': 0.9}<br>summary.core_beats_monkey_max_drawdown_rate actual=0.87175 expected={'min': 0.9} |
