...
- Variant: `dual_pressure_priority_long_1130`
- Timeframe: `5m`
...
| Limited Monkey Test | failed | summary.core_beats_monkey_net_profit_rate actual=0.8835 expected={'min': 0.9}<br>summary.core_beats_monkey_max_drawdown_rate actual=0.8525 expected={'min': 0.9} |
