...
- Variant: `morning_down_shock_reversal_long`
- Timeframe: `5m`
- Overall passed: `False`

| Stage | Status | Failed Criteria |
|---|---:|---|
| Limited Core Grid Test | failed | summary.percentage_profitable_iterations actual=0.1728395061728395 expected={'min': 0.7} |
