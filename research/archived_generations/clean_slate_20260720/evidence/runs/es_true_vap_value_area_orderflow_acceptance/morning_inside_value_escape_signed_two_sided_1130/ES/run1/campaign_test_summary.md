...
- Campaign: `es_true_vap_value_area_orderflow_acceptance`
- Variant: `morning_inside_value_escape_signed_two_sided_1130`
- Timeframe: `1m`
- Overall passed: `False`

| Stage | Status | Failed Criteria |
|---|---:|---|
| Limited Core Grid Test | failed | summary.percentage_profitable_iterations actual=0.04938271604938271 expected={'min': 0.7} |
