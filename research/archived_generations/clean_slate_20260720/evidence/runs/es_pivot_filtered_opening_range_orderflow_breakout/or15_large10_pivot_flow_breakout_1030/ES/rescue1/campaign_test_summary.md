...
- Campaign: `es_pivot_filtered_opening_range_orderflow_breakout`
- Variant: `or15_large10_pivot_flow_breakout_1030`
- Timeframe: `5m`
- Overall passed: `False`

| Stage | Status | Failed Criteria |
|---|---:|---|
| Limited Core Grid Test | failed | summary.percentage_profitable_iterations actual=0.48148148148148145 expected={'min': 0.7} |
