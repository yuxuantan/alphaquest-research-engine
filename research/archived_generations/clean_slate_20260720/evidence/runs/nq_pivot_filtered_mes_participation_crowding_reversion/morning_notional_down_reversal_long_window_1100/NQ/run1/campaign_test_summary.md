...
- Campaign: `nq_pivot_filtered_mes_participation_crowding_reversion`
- Variant: `morning_notional_down_reversal_long_window_1100`
- Timeframe: `1m`
- Overall passed: `False`

| Stage | Status | Failed Criteria |
|---|---:|---|
| Limited Core Grid Test | failed | summary.percentage_profitable_iterations actual=0.37037037037037035 expected={'min': 0.7} |
