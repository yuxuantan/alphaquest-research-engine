...
- Campaign: `nq_es_relative_value_orderflow_absorption_reversion`
- Variant: `morning30_underperform_absorption_long_1030`
- Timeframe: `1m`
- Overall passed: `False`

| Stage | Status | Failed Criteria |
|---|---:|---|
| Limited Core Grid Test | failed | summary.percentage_profitable_iterations actual=0.07407407407407407 expected={'min': 0.7} |
