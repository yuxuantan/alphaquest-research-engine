...
- Campaign: `es_vix_term_structure_orderflow_pullback`
- Variant: `front_stress_large10_vwap_reject_short_1500`
- Timeframe: `1m`
- Overall passed: `False`

| Stage | Status | Failed Criteria |
|---|---:|---|
| Limited Core Grid Test | failed | summary.percentage_profitable_iterations actual=0.018518518518518517 expected={'min': 0.7} |
