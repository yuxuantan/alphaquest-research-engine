...
- Campaign: `nq_morning_orderflow_momentum_continuation`
- Variant: `broad_large_alignment_1030_flatten_1515`
- Timeframe: `1m`
- Overall passed: `False`

| Stage | Status | Failed Criteria |
|---|---:|---|
| Limited Core Grid Test | failed | summary.percentage_profitable_iterations actual=0.13580246913580246 expected={'min': 0.7} |
