...
- Campaign: `nq_opening_drive_inventory_orderflow`
- Variant: `open30_price_flow_divergence_fade_1400`
- Timeframe: `1m`
...
| Limited Monkey Test | failed | summary.core_beats_monkey_net_profit_rate actual=0.873875 expected={'min': 0.9}<br>summary.core_beats_monkey_max_drawdown_rate actual=0.565 expected={'min': 0.9} |
