...
- Campaign: `nq_pivot_filtered_prior_value_area_acceptance`
- Variant: `late_morning_large10_two_sided_pivot_acceptance`
- Timeframe: `5m`
- Overall passed: `False`

| Stage | Status | Failed Criteria |
|---|---:|---|
| Limited Core Grid Test | failed | summary.percentage_profitable_iterations actual=0.2777777777777778 expected={'min': 0.7} |
