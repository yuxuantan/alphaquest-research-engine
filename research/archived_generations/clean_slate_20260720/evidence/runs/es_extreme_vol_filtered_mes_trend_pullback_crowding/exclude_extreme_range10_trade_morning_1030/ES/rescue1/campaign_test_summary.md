...
| Simulated Incubation (OOS) Core | failed | metrics.profit_factor actual=0.9962376624645753 expected={'min': 1.0}<br>metrics.mar actual=-0.01682924895519199 expected={'min': 1.0} |
