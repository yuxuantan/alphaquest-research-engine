...
- Variant: `midday_notional_two_sided_reversal_1200`
- Timeframe: `1m`
...
| Limited Monkey Test | failed | summary.core_beats_monkey_net_profit_rate actual=0.78825 expected={'min': 0.9}<br>summary.core_beats_monkey_max_drawdown_rate actual=0.875 expected={'min': 0.9} |
