...
- Variant: `low_downside20_1030_long_strength_efficiency`
- Timeframe: `5m`
...
| Limited Monkey Test | failed | summary.core_beats_monkey_net_profit_rate actual=0.833125 expected={'min': 0.9}<br>summary.core_beats_monkey_max_drawdown_rate actual=0.786625 expected={'min': 0.9} |
