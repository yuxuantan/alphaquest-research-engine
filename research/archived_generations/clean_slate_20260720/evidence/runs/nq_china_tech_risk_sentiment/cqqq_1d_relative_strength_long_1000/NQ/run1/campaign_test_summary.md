...
- Variant: `cqqq_1d_relative_strength_long_1000`
- Timeframe: `1m`
...
| Walk Forward Analysis (WFA) | failed | summary.early_exit actual=True expected={'equals': False}<br>stitched_oos_metrics.profit_factor actual=0.8958871915393655 expected={'min': 1.2}<br>stitched_oos_metrics.mar actual=-0.6599201927404087 expected={'min': 0.4} |
