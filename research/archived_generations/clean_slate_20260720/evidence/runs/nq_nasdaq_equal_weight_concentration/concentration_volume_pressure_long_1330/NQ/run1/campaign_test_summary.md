...
- Variant: `concentration_volume_pressure_long_1330`
- Timeframe: `1m`
...
| Limited Monkey Test | failed | summary.core_beats_monkey_net_profit_rate actual=0.60075 expected={'min': 0.9}<br>summary.core_beats_monkey_max_drawdown_rate actual=0.784125 expected={'min': 0.9} |
