...
- Variant: `monday_after_expiration_reversal_long_1000`
- Timeframe: `1m`
...
| Limited Monkey Test | failed | summary.core_beats_monkey_net_profit_rate actual=0.84275 expected={'min': 0.9}<br>summary.core_beats_monkey_max_drawdown_rate actual=0.684125 expected={'min': 0.9} |
