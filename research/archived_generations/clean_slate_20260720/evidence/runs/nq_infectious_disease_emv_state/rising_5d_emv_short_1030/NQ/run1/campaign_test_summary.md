...
- Campaign: `nq_infectious_disease_emv_state`
- Variant: `rising_5d_emv_short_1030`
- Timeframe: `1m`
...
| Limited Monkey Test | failed | summary.core_beats_monkey_net_profit_rate actual=0.89 expected={'min': 0.9}<br>summary.core_beats_monkey_max_drawdown_rate actual=0.769625 expected={'min': 0.9} |
