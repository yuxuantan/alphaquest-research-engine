...
Mechanic: After NQ has traded at least the configured distance above the current RTH open on a prior completed bar, sell a completed rejection back below the RTH open when same-bar aggregate signed flow is negative enough.
