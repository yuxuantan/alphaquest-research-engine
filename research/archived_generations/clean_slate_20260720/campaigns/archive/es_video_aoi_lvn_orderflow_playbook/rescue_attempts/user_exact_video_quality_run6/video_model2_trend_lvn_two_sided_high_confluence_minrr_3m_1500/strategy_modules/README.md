# video_model2_trend_lvn_two_sided_high_confluence_minrr_3m_1500

Run6 quality-filter variant after run5 exact-video proxy failed limited core.

Mechanic: Two-sided Model 2 trend LVN pullback with higher AOI confluence, directional delta threshold, minimum structural target distance, and fixed-R fallback.
