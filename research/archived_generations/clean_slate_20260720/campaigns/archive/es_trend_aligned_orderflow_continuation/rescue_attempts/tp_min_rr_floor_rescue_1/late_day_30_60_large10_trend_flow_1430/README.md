...
User-authorized additional rescue created on 2026-06-19. Source run: `es_trend_aligned_orderflow_continuation/late_day_30_60_large10_trend_flow_1430/run1`. Only target_r_multiple values below 1.0R were raised to 1.0R; entry, stop, data, costs, fills, sessions, and validation gates are unchanged.
