# funding_stress_short_1130

Campaign: `es_ofr_financial_stress_intraday`

Mechanic: At 11:30 ET, enter short ES when the lagged OFR funding-stress contribution rank is in the upper tail; flatten by 15:55 ET unless stop or target is hit.
