# all_day_signed_high_volume_trend_hold_two_sided rescue1

Campaign: `es_trend_filtered_prior_session_breakout_orderflow`

This is the single allowed parameter-space/fixed-parameter rescue for `all_day_signed_high_volume_trend_hold_two_sided`.
...
entry.params.min_orderflow_imbalance: [0.005, 0.01, 0.02]
