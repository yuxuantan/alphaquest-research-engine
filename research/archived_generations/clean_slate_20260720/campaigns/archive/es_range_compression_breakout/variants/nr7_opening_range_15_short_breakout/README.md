# nr7_opening_range_15_short_breakout

Mechanic: after a completed prior RTH session ranks as the narrowest range in the last seven sessions, trade only short breakouts below the completed first 15-minute opening range.

Entry timing: the opening range is complete at 09:45 ET; signals use completed 5-minute bar closes and enter on the next 5-minute bar open.
