# nr4_prior_session_breakout

Mechanic: after a completed prior RTH session ranks as the narrowest range in the last four sessions, trade a two-sided breakout of the prior RTH high or low.
...
Lookahead control: the compression condition uses only completed prior RTH sessions.
