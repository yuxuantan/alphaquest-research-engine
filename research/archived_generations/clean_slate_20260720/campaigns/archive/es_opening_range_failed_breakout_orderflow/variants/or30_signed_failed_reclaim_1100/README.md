...
Mechanic: build the completed first 30-minute RTH opening range, require a completed close outside the range, then trade the completed reclaim back through the same boundary before 11:00:00 only when the reclaim bar has opposite aggregate signed volume.
