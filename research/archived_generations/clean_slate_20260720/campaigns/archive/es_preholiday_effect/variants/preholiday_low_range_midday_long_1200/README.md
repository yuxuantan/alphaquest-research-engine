...
Mechanic: At 12:00 ET on the last regular RTH session before a full NYSE holiday, enter long ES only if the completed RTH range is no wider than the configured threshold; flatten by 15:55 ET unless stop or target is hit.
