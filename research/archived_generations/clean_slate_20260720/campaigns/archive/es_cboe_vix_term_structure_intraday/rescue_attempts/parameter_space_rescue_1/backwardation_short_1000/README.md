...
## Rescue Attempt 1
Original backwardation short failed core with 0/27 profitable combinations; rescue preserves the same backwardation short mechanic and tests a stricter upper-tail rank neighborhood with the adjacent wide-stop/high-R space preferred by the least-bad original rows.
