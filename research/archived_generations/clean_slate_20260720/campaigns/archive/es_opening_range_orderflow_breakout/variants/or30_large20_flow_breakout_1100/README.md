# or30_large20_flow_breakout_1100

Campaign: `es_opening_range_orderflow_breakout`

Mechanic: build the completed first 30-minute RTH opening range, then allow one two-sided breakout entry before 11:00 ET only when the completed 5-minute breakout bar closes beyond the range and large-20 aggregate flow is aligned.
