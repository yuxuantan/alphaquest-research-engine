...
User-authorized additional rescue created on 2026-06-19. Source run: `es_usdjpy_safe_haven_spillover/strong_yen_short_1130/rescue1`. Only stop distance was widened by 1.5x; entry, target/exit, data, costs, fills, sessions, and validation gates are unchanged.
