...
Original results were less weak at higher impulse thresholds and tighter stops. The rescue keeps the same signed-flow pause-breakout mechanic but shifts the impulse grid upward and avoids wider stops that averaged worse.
