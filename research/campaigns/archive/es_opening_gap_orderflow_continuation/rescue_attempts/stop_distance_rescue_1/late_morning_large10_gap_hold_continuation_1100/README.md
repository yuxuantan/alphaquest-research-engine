...
User-authorized additional rescue created on 2026-06-19. Source run: `es_opening_gap_orderflow_continuation/late_morning_large10_gap_hold_continuation_1100/rescue1`. Only stop distance was widened by 1.5x; entry, target/exit, data, costs, fills, sessions, and validation gates are unchanged.
