...
Mechanic: build the completed first 60-minute RTH opening range, require a completed close outside the range, then trade the completed reclaim back through the same boundary before 12:00:00 only when the reclaim bar has opposite aggregate signed volume.
