...
## Rescue Attempt 1
Original high-VIX rebound long failed core with 0/27 profitable combinations; rescue preserves the same high-VIX long mechanic and tests the adjacent tighter-stop/high-R neighborhood preferred by the least-bad original rows.
