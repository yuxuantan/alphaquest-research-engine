# all_market_nq30_1500 strategy modules
...
Mechanic: Tests prior RTH, opening-range, and overnight AOIs as a single broad market-structure family when NQ confirms ES continuation.
