# nq_prior_session_flip_retest_orderflow / late_morning_large10_absorbed_two_sided_flip
...
Source ES config: `campaigns/es_prior_session_flip_retest_orderflow/variants/late_morning_large10_absorbed_two_sided_flip/config.yaml`.
