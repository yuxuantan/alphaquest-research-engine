...
User-authorized additional rescue created on 2026-06-19. Source run: `es_cboe_vxn_vix_dispersion_intraday/falling_vxn_vix_ratio_long_1200/rescue1`. Only stop distance was widened by 1.5x; entry, target/exit, data, costs, fills, sessions, and validation gates are unchanged.
