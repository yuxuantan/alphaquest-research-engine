...
from alphaquest.strategy_modules.entry.video_exact_orderflow_playbook_scid_intrabar import _IntrabarState
from alphaquest.strategy_modules.entry.yush_trend_47 import YushTrend47Entry


class YushTrend66Entry(YushTrend47Entry):
    name = "yush_trend_66"
    ...
    def on_bar_intrabar(
        ...
        pending: dict[tuple[str, str, str, float], pd.Timestamp] = {}
        ...
        for _, tick in detail_rows.iterrows():
            ...
            for direction, model, level_type, level in candidates:
                ...
                hold_start = pending.setdefault(key, tick_timestamp)
                if tick_timestamp - hold_start < hold_delta:
                    continue
