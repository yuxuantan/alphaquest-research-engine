...
def build_entry_module(config: dict):
    name = config.get("module", "pdh_pdl_sweep_reclaim")
    params = config.get("params", {})
    if name == "pdh_pdl_sweep_reclaim":
        return PdhPdlSweepReclaimEntry(params)
    raise ValueError(f"Unknown entry module: {name}")
