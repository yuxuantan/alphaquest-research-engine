...
class VolatilityFilteredTrendMesParticipationCrowdingEntry(TrendFilteredMesParticipationCrowdingEntry):
    name = "volatility_filtered_trend_mes_participation_crowding"

    def __init__(self, params: dict):
        super().__init__(params)
        self.feature_csv = str(params.get("feature_csv", "data/external/es_lagged_volatility_features_20110103_20260609.csv"))
        self.volatility_gate_column = str(params.get("volatility_gate_column", "vol20_rank_252"))
        self.volatility_gate_max = float(params.get("volatility_gate_max", 0.95))
