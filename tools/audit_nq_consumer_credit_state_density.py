...
FEATURE_CSV = Path("data/external/nq_consumer_credit_state_features_20110103_20260612.csv")
DETAIL_CSV = Path("research_artifacts/nq_consumer_credit_state_density_audit_20260701.csv")
SUMMARY_CSV = Path("research_artifacts/nq_consumer_credit_state_density_summary_20260701.csv")
REPORT_MD = Path("research_artifacts/nq_consumer_credit_state_density_audit_20260701.md")
...
VARIANTS = [
    {
        "variant_id": "total_credit_3m_contraction_short_1000",
        "rank_column": "total_credit_change_3m_rank_120m",
        "direction_mode": "low_short",
    },
    {
        "variant_id": "revolving_credit_3m_relief_long_1030",
        "rank_column": "revolving_credit_change_3m_rank_120m",
        "direction_mode": "low_long",
    },
    {
        "variant_id": "total_credit_to_income_low_long_1130",
        "rank_column": "total_credit_to_income_rank_120m",
        "direction_mode": "low_long",
    },
    {
        "variant_id": "revolving_credit_to_income_low_long_1200",
        "rank_column": "revolving_credit_to_income_rank_120m",
        "direction_mode": "low_long",
    },
    {
        "variant_id": "revolving_credit_1m_relief_long_1330",
        "rank_column": "revolving_credit_change_1m_rank_120m",
        "direction_mode": "low_long",
    },
]
...
def _write_report(detail: pd.DataFrame, summary: pd.DataFrame) -> None:
    ...
    lines = [
        "# NQ Consumer Credit State Density Audit",
        "",
        "Date: 2026-07-01",
        "",
        f"Verdict: {verdict}",
        "",
        "This is a pre-PnL opportunity-count audit for 60-day-lagged monthly Federal Reserve/FRED consumer-credit state.",
