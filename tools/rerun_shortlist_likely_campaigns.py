...
DEFAULT_ARTIFACT_STEM = Path("_archived/research_artifacts/campaign_benchmark_shortlist_refresh_20260614")
SNAPSHOT_SOURCE_DIR = Path("_archived/research_artifacts/campaign_benchmark_shortlist_refresh_20260614_source_snapshots")
