...
DEFAULT_FEATURES = "data/external/nq_ai_gpr_features_20110103_20260612.csv"
DEFAULT_DETAIL = "research_artifacts/nq_ai_gpr_geopolitical_risk_state_density_audit_20260701.csv"
DEFAULT_SUMMARY = "research_artifacts/nq_ai_gpr_geopolitical_risk_state_density_summary_20260701.csv"
DEFAULT_MARKDOWN = "research_artifacts/nq_ai_gpr_geopolitical_risk_state_density_audit_20260701.md"


VARIANT_GRID = {
    "high_ai_gpr_short_1000": [
        {"column": "gpr_ai_21d_rank_252", "tail": "high", "gpr_rank_threshold": value}
        for value in (0.25, 0.30, 0.35)
    ],
    "high_ai_gpr_rebound_long_1330": [
        {"column": "gpr_ai_21d_rank_252", "tail": "high", "gpr_rank_threshold": value}
        for value in (0.25, 0.30, 0.35)
    ],
    "rising_ai_gpr_short_1030": [
        {"column": "gpr_ai_5d_change_rank_252", "tail": "high", "gpr_rank_threshold": value}
        for value in (0.25, 0.30, 0.35)
    ],
    "high_threats_gpr_short_1130": [
        {"column": "threats_gpr_ai_21d_rank_252", "tail": "high", "gpr_rank_threshold": value}
        for value in (0.25, 0.30, 0.35)
    ],
    "high_acts_gpr_rebound_long_1200": [
        {"column": "acts_gpr_ai_5d_rank_252", "tail": "high", "gpr_rank_threshold": value}
        for value in (0.25, 0.30, 0.35)
    ],
}
            ...
            rows.append(
                {
                    ...
                    "tail": spec["tail"],
                    "gpr_rank_threshold": spec["gpr_rank_threshold"],
...
def _mask(frame: pd.DataFrame, spec: dict) -> pd.Series:
    ...
    threshold = float(spec["gpr_rank_threshold"])
    if spec["tail"] != "high":
