...
DEFAULT_FEATURES = "data/external/nq_manufacturing_orders_state_features_20110103_20260612.csv"
DEFAULT_DETAIL = "research_artifacts/nq_manufacturing_orders_state_density_audit_20260701.csv"
DEFAULT_SUMMARY = "research_artifacts/nq_manufacturing_orders_state_density_summary_20260701.csv"
DEFAULT_MD = "research_artifacts/nq_manufacturing_orders_state_density_audit_20260701.md"
...
VARIANTS = [
    Variant("total_orders_3m_strength_long_1000", "total_orders_3m_strength_long", "long", "rank_min", (0.55, 0.60, 0.65), "total_orders_change_3m_rank_120m"),
    Variant("total_orders_3m_weakness_short_1030", "total_orders_3m_weakness_short", "short", "rank_max", (0.40, 0.45, 0.50), "total_orders_change_3m_rank_120m"),
    Variant("core_capgoods_3m_strength_long_1130", "core_capgoods_3m_strength_long", "long", "rank_min", (0.55, 0.60, 0.65), "core_capgoods_orders_change_3m_rank_120m"),
    Variant("durables_1m_weakness_short_1200", "durables_1m_weakness_short", "short", "rank_max", (0.35, 0.40, 0.45), "durable_goods_orders_change_1m_rank_120m"),
    Variant("ex_transport_3m_strength_long_1330", "ex_transport_3m_strength_long", "long", "rank_min", (0.55, 0.60, 0.65), "ex_transport_orders_change_3m_rank_120m"),
]
