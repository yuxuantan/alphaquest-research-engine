...
DEFAULT_OUTPUT = "data/external/nq_manufacturing_orders_state_features_20110103_20260612.csv"
DEFAULT_CACHE_DIR = "data/external/fred_manufacturing_orders_state"
...
SERIES = {
    ...
    "NEWORDER": "core_capgoods_orders",
    "AMXTNO": "ex_transport_orders",
}
...
def build_features(
    ...
    *,
    ...
    columns = [
        ...
        "core_capgoods_orders",
        "ex_transport_orders",
        "total_orders_change_1m",
        "total_orders_change_3m",
        "durable_goods_orders_change_1m",
        "durable_goods_orders_change_3m",
        "core_capgoods_orders_change_1m",
        "core_capgoods_orders_change_3m",
        "ex_transport_orders_change_1m",
        "ex_transport_orders_change_3m",
        "total_orders_change_1m_rank_120m",
        "total_orders_change_3m_rank_120m",
        "durable_goods_orders_change_1m_rank_120m",
        "durable_goods_orders_change_3m_rank_120m",
        "core_capgoods_orders_change_1m_rank_120m",
        "core_capgoods_orders_change_3m_rank_120m",
        "ex_transport_orders_change_1m_rank_120m",
