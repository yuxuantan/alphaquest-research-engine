...
FEATURE_CSV = Path("data/external/nq_productivity_unit_labor_cost_features_20110103_20260612.csv")
DETAIL_CSV = Path("research_artifacts/nq_productivity_unit_labor_cost_density_audit_20260701.csv")
SUMMARY_CSV = Path("research_artifacts/nq_productivity_unit_labor_cost_density_summary_20260701.csv")
REPORT_MD = Path("research_artifacts/nq_productivity_unit_labor_cost_density_audit_20260701.md")
...
VARIANTS = [
    {
        "variant_id": "productivity_1q_weakness_short_1030",
        "rank_column": "productivity_change_1q_rank_80q",
        "direction_mode": "low_short",
    },
    {
        "variant_id": "unit_labor_cost_4q_pressure_short_1130",
        "rank_column": "unit_labor_cost_change_4q_rank_80q",
        "direction_mode": "high_short",
    },
    {
        "variant_id": "unit_labor_cost_1q_relief_long_1200",
        "rank_column": "unit_labor_cost_change_1q_rank_80q",
        "direction_mode": "low_long",
    },
    {
        "variant_id": "productivity_minus_ulc_4q_margin_long_1330",
        "rank_column": "productivity_minus_ulc_change_4q_rank_80q",
        "direction_mode": "high_long",
    },
    {
        "variant_id": "productivity_minus_ulc_4q_pressure_short_1000",
        "rank_column": "productivity_minus_ulc_change_4q_rank_80q",
        "direction_mode": "low_short",
    },
]
...
def _mask(rank: pd.Series, direction_mode: str, rank_threshold: float) -> pd.Series:
    ...
    if direction_mode in {"low_short", "low_long"}:
...
def _write_report(detail: pd.DataFrame, summary: pd.DataFrame) -> None:
    ...
    lines = [
        "# NQ Productivity Unit Labor Cost Density Audit",
        "",
        "Date: 2026-07-01",
        "",
        f"Verdict: {'PASS' if pass_rows == total_rows else 'FAIL'}",
        "",
        "This is a pre-PnL opportunity-count audit for 180-day-lagged quarterly productivity and unit-labor-cost state.",
