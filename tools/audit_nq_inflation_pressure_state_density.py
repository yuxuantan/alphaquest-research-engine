...
DEFAULT_FEATURES = "data/external/nq_inflation_pressure_state_features_20110103_20260612.csv"
DEFAULT_DETAIL = "research_artifacts/nq_inflation_pressure_state_density_audit_20260701.csv"
DEFAULT_SUMMARY = "research_artifacts/nq_inflation_pressure_state_density_summary_20260701.csv"
DEFAULT_MD = "research_artifacts/nq_inflation_pressure_state_density_audit_20260701.md"
...
VARIANTS = [
    Variant("core_pce_high_short_1000", "core_pce_high_short", "short", "rank_min", (0.40, 0.45, 0.50), "core_pce_yoy_rank_120m"),
    Variant("core_pce_disinflation_long_1030", "core_pce_disinflation_long", "long", "rank_max", (0.60, 0.65, 0.70), "core_pce_yoy_change_3m_rank_120m"),
    Variant("cpi_high_short_1130", "cpi_high_short", "short", "rank_min", (0.55, 0.60, 0.65), "cpi_yoy_rank_120m"),
    Variant("core_cpi_accel_short_1200", "core_cpi_accel_short", "short", "rank_min", (0.55, 0.60, 0.65), "core_cpi_3m_ann_rank_120m"),
    Variant("pce_disinflation_long_1330", "pce_disinflation_long", "long", "rank_max", (0.60, 0.65, 0.70), "pce_3m_ann_rank_120m"),
]
