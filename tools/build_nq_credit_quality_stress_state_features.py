...
DEFAULT_OUTPUT = "data/external/nq_credit_quality_stress_state_features_20110103_20260612.csv"
DEFAULT_CACHE_DIR = "data/external/fred_credit_quality_stress_state"
FRED_URL = "https://fred.stlouisfed.org/graph/fredgraph.csv?id={series_id}"

SERIES = {
    "DRCCLACBS": "credit_card_delinquency",
    "DRCLACBS": "consumer_loan_delinquency",
    "CORCCT100S": "credit_card_chargeoff",
    "CORBLACBS": "business_loan_chargeoff",
    "CORALACBN": "all_loan_chargeoff",
}
...
def build_features(
    ...
    *,
    ...
    columns = [
        ...
        "business_loan_chargeoff",
        "all_loan_chargeoff",
        "credit_card_delinquency_change_4q",
        "consumer_loan_delinquency_change_4q",
        "credit_card_chargeoff_change_4q",
        "business_loan_chargeoff_change_4q",
        "all_loan_chargeoff_change_4q",
        "credit_card_delinquency_change_4q_rank_80q",
        "consumer_loan_delinquency_change_4q_rank_80q",
        "credit_card_chargeoff_rank_80q",
        "business_loan_chargeoff_rank_80q",
        "all_loan_chargeoff_rank_80q",
    ]
    out = out[columns]
...
def _add_state_features(
    ...
    *,
    ...
    for column in SERIES.values():
        ...
        out[f"{column}_change_4q_rank_80q"] = _rolling_last_percentile(
            out[f"{column}_change_4q"],
            rank_window_quarters,
            rank_min_periods,
        )
    return out
