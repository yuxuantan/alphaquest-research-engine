...
FEATURE_CSV = Path("data/external/nq_corporate_profitability_state_features_20110103_20260612.csv")
DETAIL_CSV = Path("research_artifacts/nq_corporate_profitability_state_density_audit_20260701.csv")
SUMMARY_CSV = Path("research_artifacts/nq_corporate_profitability_state_density_summary_20260701.csv")
REPORT_MD = Path("research_artifacts/nq_corporate_profitability_state_density_audit_20260701.md")
...
VARIANTS = [
    {
        "variant_id": "high_corporate_profit_yoy_growth_long_1000",
        "rank_column": "corporate_profits_growth_4q_rank_80q",
    },
    {
        "variant_id": "high_after_tax_profit_yoy_growth_long_1030",
        "rank_column": "after_tax_profits_growth_4q_rank_80q",
    },
    {
        "variant_id": "high_after_tax_profit_margin_long_1130",
        "rank_column": "after_tax_profit_gdp_share_rank_80q",
    },
    {
        "variant_id": "high_corporate_profit_margin_long_1200",
        "rank_column": "corporate_profit_gdp_share_rank_80q",
    },
    {
        "variant_id": "high_corporate_profit_qoq_growth_long_1330",
        "rank_column": "corporate_profits_growth_1q_rank_80q",
    },
]
...
def _write_report(detail: pd.DataFrame, summary: pd.DataFrame) -> None:
    ...
    lines = [
        "# NQ Corporate Profitability State Density Audit",
        "",
        "Date: 2026-07-01",
        "",
        f"Verdict: {verdict}",
        "",
        "This is a pre-PnL opportunity-count audit for 120-day-lagged FRED/BEA corporate-profit growth and profit-margin state.",
