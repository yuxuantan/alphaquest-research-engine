...
DEFAULT_OUTPUT = "data/external/nq_housing_construction_state_features_20110103_20260612.csv"
DEFAULT_CACHE_DIR = "data/external/fred_housing_construction_state"
FRED_URL = "https://fred.stlouisfed.org/graph/fredgraph.csv?id={series_id}"


SERIES = {
    "PERMIT": "total_permits",
    "PERMIT1": "single_family_permits",
    "PERMIT5": "multifamily_permits",
    "HOUST": "total_starts",
    "HOUST1F": "single_family_starts",
    "HOUST5F": "multifamily_starts",
}
...
def build_features(
    ...
    *,
    ...
    columns = [
        ...
        "multifamily_permits",
        "total_starts",
        "single_family_starts",
        "multifamily_starts",
        "permit_starts_ratio",
        "single_family_permit_share",
        "total_permits_change_1m",
        "total_permits_change_3m",
        "single_family_permits_change_1m",
        "single_family_permits_change_3m",
        "multifamily_permits_change_1m",
        "multifamily_permits_change_3m",
        "total_starts_change_1m",
        "total_starts_change_3m",
        "single_family_starts_change_1m",
        "single_family_starts_change_3m",
        "multifamily_starts_change_1m",
        "multifamily_starts_change_3m",
        "permit_starts_ratio_change_3m",
        "total_permits_change_3m_rank_120m",
        "single_family_permits_change_3m_rank_120m",
        "total_starts_change_3m_rank_120m",
        "multifamily_starts_change_3m_rank_120m",
        "permit_starts_ratio_rank_120m",
        "permit_starts_ratio_change_3m_rank_120m",
    ]
    out = out[columns]
...
def _add_state_features(
    ...
    *,
    ...
    out = monthly.copy()
    out["permit_starts_ratio"] = out["total_permits"] / out["total_starts"].replace(0, pd.NA)
    out["single_family_permit_share"] = out["single_family_permits"] / out[
        "total_permits"
    ].replace(0, pd.NA)
    for column in [
        "total_permits",
        ...
        out[f"{column}_change_1m"] = out[column].pct_change(1)
        out[f"{column}_change_3m"] = out[column].pct_change(3)
    out["permit_starts_ratio_change_3m"] = out["permit_starts_ratio"].pct_change(3)
