...
FEATURE_CSV = Path("data/external/nq_taiwan_semiconductor_spillover_features_20110103_20260612.csv")
DETAIL_CSV = Path("research_artifacts/nq_taiwan_semiconductor_spillover_density_audit_20260701.csv")
SUMMARY_CSV = Path("research_artifacts/nq_taiwan_semiconductor_spillover_density_summary_20260701.csv")
REPORT_MD = Path("research_artifacts/nq_taiwan_semiconductor_spillover_density_audit_20260701.md")
...
VARIANTS = [
    {
        "variant_id": "twii_1d_strength_long_1000",
        "rank_column": "twii_return_1d_rank_252",
        "direction_mode": "high_long",
    },
    {
        "variant_id": "twii_1d_weakness_short_1000",
        "rank_column": "twii_return_1d_rank_252",
        "direction_mode": "low_short",
    },
    {
        "variant_id": "tsmc_1d_relative_strength_long_1030",
        "rank_column": "tsmc_tw_twii_relative_return_1d_rank_252",
        "direction_mode": "high_long",
    },
    {
        "variant_id": "tsmc_3d_relative_weakness_short_1030",
        "rank_column": "tsmc_tw_twii_relative_return_3d_rank_252",
        "direction_mode": "low_short",
    },
    {
        "variant_id": "taiwan_1d_volatility_short_1130",
        "rank_column": "twii_abs_return_1d_rank_252",
...
def audit() -> tuple[pd.DataFrame, pd.DataFrame]:
    ...
    features = features[
        features["taiwan_observation_lag_calendar_days"].le(MAX_OBSERVATION_LAG_CALENDAR_DAYS)
    ].copy()
...
def _write_report(detail: pd.DataFrame, summary: pd.DataFrame) -> None:
    ...
    lines = [
        ...
        f"Maximum observation lag allowed for signals: {MAX_OBSERVATION_LAG_CALENDAR_DAYS} calendar days",
        "",
        "## Variant Summary",
        "",
