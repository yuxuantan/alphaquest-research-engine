...
DEFAULT_OUTPUT = "data/external/nq_jobless_claims_state_features_20110103_20260612.csv"
DEFAULT_CACHE_DIR = "data/external/fred_jobless_claims_state"
FRED_URL = "https://fred.stlouisfed.org/graph/fredgraph.csv?id={series_id}"


SERIES = {
    "ICSA": "initial_claims",
    "IC4WSA": "initial_claims_4w",
    "CCSA": "continued_claims",
    "CC4WSA": "continued_claims_4w",
}
...
def build_features(
    ...
    *,
    ...
    rank_window_weeks: int = 156,
    rank_min_periods: int = 52,
    ...
    columns = [
        ...
        "continued_claims",
        "continued_claims_4w",
        "initial_claims_4w_change_1w",
        "initial_claims_4w_change_4w",
        "continued_claims_4w_change_1w",
        "continued_claims_4w_change_4w",
        "initial_claims_4w_rank_156w",
        "continued_claims_4w_rank_156w",
        "initial_claims_4w_change_1w_rank_156w",
        "initial_claims_4w_change_4w_rank_156w",
        "continued_claims_4w_change_1w_rank_156w",
        "continued_claims_4w_change_4w_rank_156w",
    ]
    out = out[columns]
...
def _add_state_features(
    ...
    *,
    ...
    out = weekly.copy()
    for column in ["initial_claims_4w", "continued_claims_4w"]:
        out[f"{column}_change_1w"] = out[column].pct_change(1)
        out[f"{column}_change_4w"] = out[column].pct_change(4)
        out[f"{column}_rank_156w"] = _rolling_last_percentile(
            out[column],
            rank_window_weeks,
            rank_min_periods,
        )
...
def main() -> None:
    ...
    parser.add_argument("--availability-lag-days", type=int, default=7)
