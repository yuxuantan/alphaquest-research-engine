...
DEFAULT_FEATURES = "data/external/nq_retail_inventory_demand_features_20110103_20260612.csv"
DEFAULT_DETAIL = "research_artifacts/nq_retail_inventory_demand_density_audit_20260701.csv"
DEFAULT_SUMMARY = "research_artifacts/nq_retail_inventory_demand_density_summary_20260701.csv"
DEFAULT_MD = "research_artifacts/nq_retail_inventory_demand_density_audit_20260701.md"
...
VARIANTS = [
    Variant("retail_3m_weakness_long_1000", "retail_3m_weakness_long", "long", "rank_max", (0.55, 0.60, 0.65), "retail_sales_ex_auto_change_3m_rank_120m"),
    Variant("retail_3m_strength_short_1030", "retail_3m_strength_short", "short", "rank_min", (0.55, 0.60, 0.65), "retail_sales_ex_auto_change_3m_rank_120m"),
    Variant("retail_1m_strength_long_1130", "retail_1m_strength_long", "long", "rank_min", (0.55, 0.60, 0.65), "retail_sales_change_1m_rank_120m"),
    Variant("inventory_sales_low_long_1200", "inventory_sales_low_long", "long", "rank_max", (0.35, 0.40, 0.45), "inventory_sales_ratio_rank_120m"),
    Variant("inventory_sales_falling_long_1330", "inventory_sales_falling_long", "long", "rank_max", (0.40, 0.45, 0.50), "inventory_sales_ratio_change_3m_rank_120m"),
]
