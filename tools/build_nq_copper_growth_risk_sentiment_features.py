...
DEFAULT_OUTPUT = "data/external/nq_copper_growth_risk_sentiment_features_20110103_20260612.csv"
DEFAULT_CACHE_DIR = "data/external/yahoo_copper_gold_futures"
...
def build_features(
    ...
    *,
    ...
    availability_lag_calendar_days: int = 1,
    ...
    sessions["availability_cutoff"] = sessions["session_date_ts"] - pd.Timedelta(
        days=int(availability_lag_calendar_days)
    )

    copper = _load_or_fetch_yahoo("HG=F", cache_dir, yahoo_start_date, yahoo_end_date, "copper")
    gold = _load_or_fetch_yahoo("GC=F", cache_dir, yahoo_start_date, yahoo_end_date, "gold")
    daily = pd.merge(
        copper,
        gold,
        on="observation_date",
    ...
    daily["copper_gold_ratio"] = daily["copper"] / daily["gold"]

    for lookback in (1, 3, 5):
        daily[f"copper_return_{lookback}d"] = daily["copper"].pct_change(lookback)
        daily[f"copper_gold_ratio_return_{lookback}d"] = daily[
            "copper_gold_ratio"
        ].pct_change(lookback)
    daily["copper_abs_return_1d"] = daily["copper_return_1d"].abs()
    daily["copper_volume_median_20"] = daily["copper_volume"].rolling(
        20, min_periods=10
    ).median()
    daily["copper_volume_ratio_20"] = daily["copper_volume"] / daily[
        "copper_volume_median_20"
    ]
    ...
    rank_columns = [
        ...
        "copper_return_3d",
        "copper_return_5d",
        "copper_gold_ratio_return_1d",
        "copper_gold_ratio_return_3d",
        "copper_gold_ratio_return_5d",
        "copper_abs_return_1d",
        "copper_volume_ratio_20",
    ]
    ...
    merged["availability_lag_calendar_days"] = int(availability_lag_calendar_days)
    ...
    columns = [
        ...
        "copper_abs_return_1d",
        "copper_volume_ratio_20",
        "copper_return_1d_rank_252",
        "copper_return_3d_rank_252",
        "copper_return_5d_rank_252",
        "copper_gold_ratio_return_1d_rank_252",
        "copper_gold_ratio_return_3d_rank_252",
        "copper_gold_ratio_return_5d_rank_252",
        "copper_abs_return_1d_rank_252",
        "copper_volume_ratio_20_rank_252",
    ]
    out = out[columns]
