...
DEFAULT_OUTPUT = "data/external/nq_retail_inventory_demand_features_20110103_20260612.csv"
DEFAULT_CACHE_DIR = "data/external/fred_retail_inventory_demand"
FRED_URL = "https://fred.stlouisfed.org/graph/fredgraph.csv?id={series_id}"


SERIES = {
    "RSAFS": "retail_sales",
    "RSXFS": "retail_sales_ex_auto",
...
def build_features(
    ...
    *,
    ...
    columns = [
        ...
        "retail_sales_change_1m",
        "retail_sales_change_3m",
        "retail_sales_ex_auto_change_1m",
        "retail_sales_ex_auto_change_3m",
        "inventory_sales_ratio_change_3m",
        "business_inventories_change_3m",
        "retail_sales_change_1m_rank_120m",
        "retail_sales_change_3m_rank_120m",
        "retail_sales_ex_auto_change_1m_rank_120m",
        "retail_sales_ex_auto_change_3m_rank_120m",
        "inventory_sales_ratio_rank_120m",
        "inventory_sales_ratio_change_3m_rank_120m",
        "business_inventories_change_3m_rank_120m",
    ]
    out = out[columns]
...
def _add_state_features(
    ...
    *,
    ...
    out = monthly.copy()
    out["retail_sales_change_1m"] = out["retail_sales"].pct_change(1)
    out["retail_sales_change_3m"] = out["retail_sales"].pct_change(3)
    out["retail_sales_ex_auto_change_1m"] = out["retail_sales_ex_auto"].pct_change(1)
    out["retail_sales_ex_auto_change_3m"] = out["retail_sales_ex_auto"].pct_change(3)
    out["inventory_sales_ratio_change_3m"] = out["inventory_sales_ratio"].pct_change(3)
    out["business_inventories_change_3m"] = out["business_inventories"].pct_change(3)
    for column in [
        "retail_sales_change_1m",
        "retail_sales_change_3m",
        "retail_sales_ex_auto_change_1m",
