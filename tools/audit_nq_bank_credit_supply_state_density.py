...
FEATURE_CSV = Path("data/external/nq_bank_credit_supply_state_features_20110103_20260612.csv")
DETAIL_CSV = Path("research_artifacts/nq_bank_credit_supply_state_density_audit_20260701.csv")
SUMMARY_CSV = Path("research_artifacts/nq_bank_credit_supply_state_density_summary_20260701.csv")
REPORT_MD = Path("research_artifacts/nq_bank_credit_supply_state_density_audit_20260701.md")
...
VARIANTS = [
    {
        "variant_id": "high_bank_credit_growth_long_1000",
        "rank_column": "bank_credit_change_13w_rank_260w",
    },
    {
        "variant_id": "high_loans_leases_growth_long_1030",
        "rank_column": "loans_leases_change_4w_rank_260w",
    },
    {
        "variant_id": "high_ci_loans_growth_long_1130",
        "rank_column": "ci_loans_change_13w_rank_260w",
    },
    {
        "variant_id": "high_deposits_growth_long_1200",
        "rank_column": "deposits_change_13w_rank_260w",
    },
    {
        "variant_id": "high_total_assets_growth_long_1330",
        "rank_column": "total_assets_change_4w_rank_260w",
    },
]
...
def _write_report(detail: pd.DataFrame, summary: pd.DataFrame) -> None:
    ...
    lines = [
        "# NQ Bank Credit Supply State Density Audit",
        "",
        "Date: 2026-07-01",
        "",
        f"Verdict: {verdict}",
        "",
        "This is a pre-PnL opportunity-count audit for 14-day-lagged Federal Reserve/FRED H.8 bank-credit and balance-sheet state.",
