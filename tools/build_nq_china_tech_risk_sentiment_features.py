...
DEFAULT_OUTPUT = "data/external/nq_china_tech_risk_sentiment_features_20110103_20260612.csv"
DEFAULT_CACHE_DIR = "data/external/yahoo_china_tech_risk_sentiment"
...
def build_features(
    ...
    *,
    ...
    yahoo_start_date: str = "2009-01-01",
    ...
    rank_columns = [
        "cqqq_qqq_relative_return_1d",
        "cqqq_qqq_relative_return_3d",
        "cqqq_qqq_relative_return_5d",
        "fxi_qqq_relative_return_1d",
        "fxi_qqq_relative_return_3d",
        "fxi_qqq_relative_return_5d",
        "cqqq_abs_return_1d",
        "fxi_abs_return_1d",
        "cqqq_volume_ratio_20",
        "fxi_volume_ratio_20",
    ]
    ...
    columns = [
        ...
        "cqqq_qqq_relative_return_5d_rank_252",
        "fxi_qqq_relative_return_1d_rank_252",
        "fxi_qqq_relative_return_3d_rank_252",
        "fxi_qqq_relative_return_5d_rank_252",
        "cqqq_abs_return_1d_rank_252",
        "fxi_abs_return_1d_rank_252",
        "cqqq_volume_ratio_20_rank_252",
...
def main() -> None:
    ...
    parser.add_argument("--yahoo-start-date", default="2009-01-01")
