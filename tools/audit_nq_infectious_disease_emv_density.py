...
DEFAULT_FEATURES = "data/external/nq_infectious_disease_emv_features_20110103_20260612.csv"
DEFAULT_DETAIL = "research_artifacts/nq_infectious_disease_emv_state_density_audit_20260701.csv"
DEFAULT_SUMMARY = "research_artifacts/nq_infectious_disease_emv_state_density_summary_20260701.csv"
DEFAULT_MARKDOWN = "research_artifacts/nq_infectious_disease_emv_state_density_audit_20260701.md"


VARIANT_GRID = {
    "high_21d_emv_riskoff_short_1000": [
        {"column": "infect_emv_21d_rank_252", "tail": "high", "emv_rank_threshold": value}
        for value in (0.40, 0.45, 0.50)
    ],
    "high_21d_emv_rebound_long_1330": [
        {"column": "infect_emv_21d_rank_252", "tail": "high", "emv_rank_threshold": value}
        for value in (0.40, 0.45, 0.50)
    ],
    "rising_5d_emv_short_1030": [
        {"column": "infect_emv_5d_change_rank_252", "tail": "high", "emv_rank_threshold": value}
        for value in (0.25, 0.30, 0.35)
    ],
    "high_7d_emv_short_1130": [
        {"column": "infect_emv_7d_rank_252", "tail": "high", "emv_rank_threshold": value}
        for value in (0.35, 0.40, 0.45)
    ],
    "high_1d_emv_rebound_long_1200": [
        {"column": "infect_emv_1d_rank_252", "tail": "high", "emv_rank_threshold": value}
            ...
            rows.append(
                {
                    ...
                    "tail": spec["tail"],
                    "emv_rank_threshold": spec["emv_rank_threshold"],
...
def _mask(frame: pd.DataFrame, spec: dict) -> pd.Series:
    ...
    threshold = float(spec["emv_rank_threshold"])
    if spec["tail"] != "high":
