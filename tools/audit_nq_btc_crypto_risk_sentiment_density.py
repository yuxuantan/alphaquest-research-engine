...
DEFAULT_FEATURES = "data/external/nq_btc_crypto_risk_sentiment_features_20150115_20260612.csv"
DEFAULT_DETAIL = "research_artifacts/nq_btc_crypto_risk_sentiment_density_audit_20260701.csv"
DEFAULT_SUMMARY = "research_artifacts/nq_btc_crypto_risk_sentiment_density_summary_20260701.csv"
DEFAULT_MD = "research_artifacts/nq_btc_crypto_risk_sentiment_density_audit_20260701.md"
...
VARIANTS = [
    Variant("btc_1d_strength_long_1000", "btc_1d_strength_long", "long", "rank_min", (0.55, 0.60, 0.65), "btc_return_1d_rank_252"),
    Variant("btc_3d_strength_long_1030", "btc_3d_strength_long", "long", "rank_min", (0.55, 0.60, 0.65), "btc_return_3d_rank_252"),
    Variant("btc_1d_weakness_short_1000", "btc_1d_weakness_short", "short", "rank_max", (0.35, 0.40, 0.45), "btc_return_1d_rank_252"),
    Variant("btc_3d_weakness_short_1130", "btc_3d_weakness_short", "short", "rank_max", (0.35, 0.40, 0.45), "btc_return_3d_rank_252"),
    Variant("btc_volatility_riskoff_short_1330", "btc_volatility_riskoff_short", "short", "rank_min", (0.55, 0.60, 0.65), "btc_abs_return_1d_rank_252"),
]


WINDOWS = {
    "full": ("2015-01-15", "2026-06-12"),
    "limited_core_proxy": ("2015-02-22", "2016-04-15"),
...
def _signal_mask(features: pd.DataFrame, variant: Variant, threshold: float) -> pd.Series:
    if variant.direction == "long" or variant.setup_mode == "btc_volatility_riskoff_short":
        return features[variant.rank_column] >= threshold
    return features[variant.rank_column] <= threshold
