...
FEATURE_CSV = Path("data/external/nq_sloos_bank_lending_survey_state_features_20110103_20260612.csv")
DETAIL_CSV = Path("research_artifacts/nq_sloos_bank_lending_survey_state_density_audit_20260701.csv")
SUMMARY_CSV = Path("research_artifacts/nq_sloos_bank_lending_survey_state_density_summary_20260701.csv")
REPORT_MD = Path("research_artifacts/nq_sloos_bank_lending_survey_state_density_audit_20260701.md")
...
VARIANTS = [
    {
        "variant_id": "strong_ci_large_demand_long_1000",
        "rank_column": "ci_large_demand_rank_80q",
    },
    {
        "variant_id": "strong_ci_small_demand_long_1030",
        "rank_column": "ci_small_demand_rank_80q",
    },
    {
        "variant_id": "broad_ci_demand_average_long_1130",
        "rank_column": "ci_demand_rank_average_80q",
    },
    {
        "variant_id": "either_ci_demand_strength_long_1200",
        "rank_column": "ci_demand_rank_max_80q",
    },
    {
        "variant_id": "confirmed_ci_demand_strength_long_1330",
        "rank_column": "ci_demand_rank_min_80q",
    },
]
...
def _write_report(detail: pd.DataFrame, summary: pd.DataFrame) -> None:
    ...
    lines = [
        "# NQ SLOOS Bank Lending Survey State Density Audit",
        "",
        "Date: 2026-07-01",
        "",
        f"Verdict: {verdict}",
        "",
        "This is a pre-PnL opportunity-count audit for 75-day-lagged Federal Reserve/FRED Senior Loan Officer Opinion Survey commercial-and-industrial loan-demand state.",
