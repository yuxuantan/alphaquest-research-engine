...
DEFAULT_OUTPUT = "data/external/nq_industrial_production_state_features_20110103_20260612.csv"
DEFAULT_CACHE_DIR = "data/external/fred_industrial_production"
...
def build_features(
    ...
    *,
    ...
    columns = [
        ...
        "ipman_change_6m_rank_120m",
        "indpro_change_3m_rank_120m",
...
def _add_state_features(
    ...
    *,
    ...
    out = monthly.copy()
    out["ipman_change_1m"] = out["ipman"].pct_change(1)
    out["ipman_change_3m"] = out["ipman"].pct_change(3)
    out["ipman_change_6m"] = out["ipman"].pct_change(6)
    out["indpro_change_3m"] = out["indpro"].pct_change(3)
    out["cumfns_change_3m"] = out["cumfns"].pct_change(3)
    for column in [
        "ipman",
        "cumfns",
        "ipman_change_3m",
