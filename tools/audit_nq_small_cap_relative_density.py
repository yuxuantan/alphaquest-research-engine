...
DEFAULT_FEATURES = "data/external/nq_small_cap_relative_features_20110103_20260612.csv"
DEFAULT_DETAIL = "research_artifacts/nq_small_cap_relative_rotation_density_audit_20260701.csv"
DEFAULT_SUMMARY = "research_artifacts/nq_small_cap_relative_rotation_density_summary_20260701.csv"
DEFAULT_MARKDOWN = "research_artifacts/nq_small_cap_relative_rotation_density_audit_20260701.md"


VARIANT_GRID = {
    "iwm_1d_strength_long_1000": [
        {"column": "iwm_minus_qqq_1d_rank_252", "op": ">=", "rank_min": value}
        for value in (0.55, 0.60, 0.65)
    ],
    "iwm_5d_strength_long_1030": [
        {"column": "iwm_minus_qqq_5d_rank_252", "op": ">=", "rank_min": value}
        for value in (0.55, 0.60, 0.65)
    ],
    "iwm_1d_weakness_short_1000": [
        {"column": "iwm_minus_qqq_1d_rank_252", "op": "<=", "rank_max": value}
        for value in (0.45, 0.40, 0.35)
    ],
    "iwm_5d_weakness_short_1130": [
        {"column": "iwm_minus_qqq_5d_rank_252", "op": "<=", "rank_max": value}
        for value in (0.45, 0.40, 0.35)
    ],
    "iwm_attention_strength_long_1330": [
        {
            "column": "iwm_attention_pressure_1d_rank_252",
            "op": ">=",
            "rank_min": rank_min,
...
def _mask(frame: pd.DataFrame, spec: dict) -> pd.Series:
    ...
    if "volume_rank_min" in spec:
        volume = pd.to_numeric(frame["iwm_volume_ratio_20_rank_252"], errors="coerce")
