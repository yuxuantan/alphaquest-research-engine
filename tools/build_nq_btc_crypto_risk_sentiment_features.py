...
DEFAULT_OUTPUT = "data/external/nq_btc_crypto_risk_sentiment_features_20150115_20260612.csv"
DEFAULT_CACHE_DIR = "data/external/yahoo_crypto_assets"
...
def build_features(
    ...
    *,
    ...
    start_session: str = "2015-01-15",
    yahoo_start_date: str = "2014-09-17",
    ...
    daily = _load_or_fetch_yahoo(
        "BTC-USD", cache_dir, yahoo_start_date, yahoo_end_date, "btc"
    )
    for lookback in (1, 3, 7):
        daily[f"btc_return_{lookback}d"] = daily["btc"].pct_change(lookback)
    daily["btc_abs_return_1d"] = daily["btc_return_1d"].abs()
    daily["btc_volume_median_20"] = daily["btc_volume"].rolling(20, min_periods=10).median()
    daily["btc_volume_ratio_20"] = daily["btc_volume"] / daily["btc_volume_median_20"]
    daily["btc_attention_pressure_1d"] = daily["btc_return_1d"] * daily[
        "btc_volume_ratio_20"
    ]
    ...
    columns = [
        ...
        "btc_volume_ratio_20",
        "btc_attention_pressure_1d",
        "btc_return_1d_rank_252",
        "btc_return_3d_rank_252",
        "btc_return_7d_rank_252",
        "btc_abs_return_1d_rank_252",
        "btc_volume_ratio_20_rank_252",
        "btc_attention_pressure_1d_rank_252",
    ]
    out = out[columns]
...
def main() -> None:
    ...
    parser.add_argument("--yahoo-start-date", default="2014-09-17")
    ...
    valid = features.dropna(subset=["btc_return_1d_rank_252", "btc_return_3d_rank_252"])
