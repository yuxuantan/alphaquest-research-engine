...
DEFAULT_OUTPUT = "data/external/nq_consumer_credit_state_features_20110103_20260612.csv"
DEFAULT_CACHE_DIR = "data/external/fred_consumer_credit_state"
FRED_URL = "https://fred.stlouisfed.org/graph/fredgraph.csv?id={series_id}"

SERIES = {
    "TOTALSL": "total_credit",
    "REVOLSL": "revolving_credit",
    "NONREVSL": "nonrevolving_credit",
...
def build_features(
    ...
    *,
    ...
    columns = [
        ...
        "nonrevolving_credit",
        "disposable_income",
        "total_credit_change_1m",
        "total_credit_change_3m",
        "revolving_credit_change_1m",
        "revolving_credit_change_3m",
        "nonrevolving_credit_change_3m",
        "revolving_credit_share",
        "total_credit_to_income",
        "revolving_credit_to_income",
        "total_credit_change_1m_rank_120m",
        "total_credit_change_3m_rank_120m",
        "revolving_credit_change_1m_rank_120m",
        "revolving_credit_change_3m_rank_120m",
        "nonrevolving_credit_change_3m_rank_120m",
        "revolving_credit_share_rank_120m",
        "total_credit_to_income_rank_120m",
...
def _add_state_features(
    ...
    *,
    ...
    out = monthly.copy()
    out["total_credit_change_1m"] = out["total_credit"].pct_change(1)
    out["total_credit_change_3m"] = out["total_credit"].pct_change(3)
    out["revolving_credit_change_1m"] = out["revolving_credit"].pct_change(1)
    out["revolving_credit_change_3m"] = out["revolving_credit"].pct_change(3)
    out["nonrevolving_credit_change_3m"] = out["nonrevolving_credit"].pct_change(3)
    out["revolving_credit_share"] = out["revolving_credit"] / out["total_credit"]
    # Credit series are in millions; DSPI is billions at annual rate.
    out["total_credit_to_income"] = out["total_credit"] / (out["disposable_income"] * 1000.0)
    out["revolving_credit_to_income"] = out["revolving_credit"] / (
        out["disposable_income"] * 1000.0
    )
    for column in [
        "total_credit_change_1m",
        "total_credit_change_3m",
