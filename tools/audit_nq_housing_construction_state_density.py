...
DEFAULT_FEATURES = "data/external/nq_housing_construction_state_features_20110103_20260612.csv"
DEFAULT_DETAIL = "research_artifacts/nq_housing_construction_state_density_audit_20260701.csv"
DEFAULT_SUMMARY = "research_artifacts/nq_housing_construction_state_density_summary_20260701.csv"
DEFAULT_MD = "research_artifacts/nq_housing_construction_state_density_audit_20260701.md"
...
VARIANTS = [
    Variant("permits_3m_strength_long_1000", "permits_3m_strength_long", "long", "rank_min", (0.55, 0.60, 0.65), "total_permits_change_3m_rank_120m"),
    Variant("starts_3m_weakness_short_1030", "starts_3m_weakness_short", "short", "rank_max", (0.50, 0.55, 0.60), "total_starts_change_3m_rank_120m"),
    Variant("single_family_permits_strength_long_1130", "single_family_permits_strength_long", "long", "rank_min", (0.45, 0.50, 0.55), "single_family_permits_change_3m_rank_120m"),
    Variant("multifamily_starts_weakness_short_1200", "multifamily_starts_3m_weakness_short", "short", "rank_max", (0.40, 0.45, 0.50), "multifamily_starts_change_3m_rank_120m"),
    Variant("permit_starts_ratio_high_long_1330", "permit_starts_ratio_high_long", "long", "rank_min", (0.55, 0.60, 0.65), "permit_starts_ratio_rank_120m"),
]
