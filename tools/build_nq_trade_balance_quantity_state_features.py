...
DEFAULT_OUTPUT = "data/external/nq_trade_balance_quantity_state_features_20110103_20260612.csv"
DEFAULT_CACHE_DIR = "data/external/fred_trade_balance_quantity_state"
...
def build_features(
    ...
    *,
    ...
    columns = [
        ...
        "exports",
        "imports",
        "trade_balance_to_trade",
        "export_import_ratio",
        "exports_change_3m",
        "imports_change_3m",
        "balance_change_3m",
        "export_minus_import_growth_3m",
        "trade_balance_to_trade_rank_120m",
        "export_import_ratio_rank_120m",
        "exports_change_3m_rank_120m",
        "imports_change_3m_rank_120m",
        "balance_change_3m_rank_120m",
        "export_minus_import_growth_3m_rank_120m",
    ]
    out = out[columns]
...
def _add_state_features(
    ...
    *,
    ...
    out = monthly.copy()
    total_trade = out["exports"] + out["imports"]
    out["trade_balance_to_trade"] = out["trade_balance"] / total_trade
    out["export_import_ratio"] = out["exports"] / out["imports"]
    out["exports_change_3m"] = out["exports"].pct_change(3)
    out["imports_change_3m"] = out["imports"].pct_change(3)
    out["balance_change_3m"] = out["trade_balance"].diff(3)
    out["export_minus_import_growth_3m"] = out["exports_change_3m"] - out["imports_change_3m"]
    for column in [
        "trade_balance_to_trade",
        "export_import_ratio",
        "exports_change_3m",
